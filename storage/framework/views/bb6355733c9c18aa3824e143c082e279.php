<?php $__env->startSection('title', __('messages.admin_edit_cms_page')); ?>

<?php $__env->startSection('content'); ?>
<div class="py-12">
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900"><?php echo e(__('messages.edit')); ?> <?php echo e(__('messages.page')); ?></h2>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            <form action="<?php echo e(route('admin.cms-pages.update', $cmsPage)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                        id="slug"
                        name="slug"
                        value="<?php echo e(old('slug', $cmsPage->slug)); ?>"
                        required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                        id="title"
                        name="title"
                        value="<?php echo e(old('title', $cmsPage->title)); ?>"
                        required
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('content', $cmsPage->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                        id="meta_title"
                        name="meta_title"
                        value="<?php echo e(old('meta_title', $cmsPage->meta_title)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        rows="3"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('meta_description', $cmsPage->meta_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" 
                            name="is_active"
                            value="1"
                            <?php echo e(old('is_active', $cmsPage->is_active) ? 'checked' : ''); ?>
                ...
                <div class="flex items-center justify-end gap-4">
                    ...
                    <button type="submit" 
                        ...
                        <?php echo e(__('messages.update_page')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\cms-pages\edit.blade.php ENDPATH**/ ?>