<?php $__env->startSection('title', __('messages.admin_create_landing_section')); ?>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.admin_create_landing_section')); ?></h1>
                    <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.add_new_section_homepage')); ?></p>
                </div>
        ...
        <form action="<?php echo e(route('admin.landing-page.store')); ?>" method="POST" class="space-y-6" id="section-form">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $sectionTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('section_type') === $key ? 'selected' : ''); ?>>
                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('subtitle')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="hidden" name="content" id="content-input" value="<?php echo e(old('content', '{}')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                            ...
                            value="<?php echo e(old('background_color')); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" 
                            id="text_color"
                            name="text_color"
                            value="<?php echo e(old('text_color')); ?>"
                ...
                <div>
                    ...
                    <select name="alignment" id="alignment"
                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                        <option value="left" <?php echo e(old('alignment', 'center') === 'left' ? 'selected' : ''); ?>><?php echo e(__('messages.left')); ?></option>
                        <option value="center" <?php echo e(old('alignment', 'center') === 'center' ? 'selected' : ''); ?>><?php echo e(__('messages.center')); ?></option>
                        <option value="right" <?php echo e(old('alignment', 'center') === 'right' ? 'selected' : ''); ?>><?php echo e(__('messages.right')); ?></option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\landing-page\create.blade.php ENDPATH**/ ?>