<?php $__env->startSection('title', __('messages.invite_team') . ' - ' . $workspace->name); ?>
...
<div class="py-8 sm:py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">Workspace: <strong><?php echo e($workspace->name); ?></strong></p>
                </div>
                <a href="<?php echo e(route('workspaces.show', $workspace)); ?>" class="text-gray-600 hover:text-gray-900">
                    ← Back to Workspace
                </a>
            </div>
        </div>
                    ...
                    <div class="ml-3">
                        ...
                        <?php if(session('invite_link')): ?>
                            <div class="mt-3 p-3 bg-white rounded border border-green-200">
                                <p class="text-xs text-gray-600 mb-2">Invitation link untuk <strong><?php echo e(session('invited_email')); ?></strong>:</p>
                                <div class="flex items-center gap-2">
                                    <input type="text" 
                                           value="<?php echo e(session('invite_link')); ?>" 
                                           readonly 
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-8">
            ...
            <form action="<?php echo e(route('workspaces.invite.store', $workspace)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-3">
                    <?php $__currentLoopData = $pendingInvitations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invitation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">
                                            Invited by <?php echo e($invitation->inviter->name); ?> • 
                                            Role: <span class="font-semibold"><?php echo e(ucfirst($invitation->role)); ?></span> • 
                                            Expires: <?php echo e($invitation->expires_at->format('d M Y')); ?>
                            ...
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('register', ['invite' => $invitation->token])); ?>" 
                                   target="_blank"
                                   class="text-xs text-blue-600 hover:text-blue-700 font-medium">
                                    View Link
                                </a>
                                <form action="<?php echo e(route('workspaces.invite.cancel', [$workspace, $invitation])); ?>" 
                                      method="POST" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\workspaces\invite.blade.php ENDPATH**/ ?>