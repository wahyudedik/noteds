        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex-1 lg:flex lg:items-center lg:justify-center min-w-0">
                <h1 class="text-lg font-semibold text-gray-900 dark:text-white truncate">
                    <?php echo $__env->yieldContent('page-title', config('app.name', 'Noteds')); ?>
                </h1>
            </div>
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-cloak @click.away="open = false" x-transition
                        ...
                        <a href="<?php echo e(route('locale.switch', 'en')); ?>"
                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(app()->getLocale() === 'en' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : ''); ?>">
                            🇺🇸 English
                        </a>
                        <a href="<?php echo e(route('locale.switch', 'id')); ?>"
                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(app()->getLocale() === 'id' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : ''); ?>">
                            🇮🇩 Indonesia
                        </a>
                        <a href="<?php echo e(route('locale.switch', 'ar')); ?>"
                            class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(app()->getLocale() === 'ar' ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : ''); ?>">
                            🇸🇦 العربية
                        </a>
                    </div>
                </div>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative" x-data="{ 
                            ...
                            init() {
                                try {
                                    if (window.Echo && <?php echo e(auth()->check() ? 'true' : 'false'); ?>) {
                            ...
                            <button @click="open = !open"
                                ...
                                <?php if($unreadCount > 0): ?>
                                    <span
                                        class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-white transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full" data-notif-badge><?php echo e($unreadCount); ?></span>
                                <?php endif; ?>
                            </button>
                            ...
                            <div x-show="open" x-cloak @click.away="open = false" x-transition
                                ...
                                <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white"><?php echo e(__('messages.notifications')); ?>

                                    </h3>
                                    <?php if($unreadCount > 0): ?>
                                        <a href="<?php echo e(route('notifications.index')); ?>"
                                            class="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300"><?php echo e(__('messages.view_all')); ?></a>
                                    <?php endif; ?>
                                </div>
                                <?php
                                ...
                                <div id="notif-list">
                                    <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php echo $__env->make('partials.notification-item', ['notification' => $notification], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <div class="px-4 py-8 text-center" data-notif-empty>
                                            ...
                                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                                <?php echo e(__('messages.no_notifications_yet')); ?></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <script>
                        ...
                        <div class="relative" x-data="{ open: false }">
                                ...
                                <div
                                    ...
                                    <?php if(auth()->user()->avatar): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            ?>
                                            <img src="<?php echo e(asset('storage/' . $avatarPath)); ?>" alt="<?php echo e(auth()->user()->name); ?>"
                                                class="w-8 h-8 rounded-full object-cover"
                                                loading="lazy"
                                                onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                        <?php endif; ?>
                                    <?php endif; ?>
                                    <span
                                        class="text-xs font-semibold text-white" style="display: <?php echo e(auth()->user()->avatar ? 'none' : 'flex'); ?>;"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></span>
                                </div>
                            ...
                            <div x-show="open" x-cloak @click.away="open = false" x-transition
                                ...
                                <a href="<?php echo e(route('public.profile.show', auth()->user()->username)); ?>"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <?php echo e(__('messages.view_public_profile')); ?>
                                ...
                                <a href="<?php echo e(route('support-tickets.create')); ?>"
                                    class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-150">
                                    <div class="flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                        ...
                                        <?php echo e(__('messages.support_ticket')); ?>
                                ...
                                <?php if(auth()->user()->hasRole('admin')): ?>
                                    <a href="/telescope" target="_blank"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <?php echo e(__('messages.telescope')); ?>
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views/components/top-nav.blade.php ENDPATH**/ ?>