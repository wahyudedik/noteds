<?php $__env->startSection('title', __('messages.bookmarked_posts_forum')); ?>
...
<div class="py-8 sm:py-12 bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Bookmarked Posts -->
        <?php if($bookmarkedPosts->count() > 0): ?>
            <div class="space-y-4">
                <?php $__currentLoopData = $bookmarkedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
            ...
            <!-- Pagination -->
            <div class="mt-6">
                <?php echo e($bookmarkedPosts->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\forum\bookmarks.blade.php ENDPATH**/ ?>