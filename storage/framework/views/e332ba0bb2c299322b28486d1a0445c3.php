<?php $__env->startSection('title', __('messages.admin_create_documentation')); ?>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.admin_create_documentation')); ?></h1>
                    <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.create_new_documentation')); ?></p>
                </div>
        ...
        <form action="<?php echo e(route('admin.documentations.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('summary')); ?></textarea>
                    <p class="mt-1 text-xs text-gray-500"><span id="summary-char-count"><?php echo e(strlen(old('summary', ''))); ?></span>/500 <?php echo e(__('messages.characters')); ?></p>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" 
                        id="tags"
                        name="tags_input"
                        value="<?php echo e(old('tags_input')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\documentations\create.blade.php ENDPATH**/ ?>