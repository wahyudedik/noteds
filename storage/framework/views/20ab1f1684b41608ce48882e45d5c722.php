<?php $__env->startSection('title', 'Create Certification'); ?>
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h2 class="text-lg font-semibold text-gray-900">Create Certification</h2>
            </div>
            <div class="p-6">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="category" id="category" required
                                ...
                                <option value="development" <?php echo e(old('category') === 'development' ? 'selected' : ''); ?>>Development</option>
                                <option value="design" <?php echo e(old('category') === 'design' ? 'selected' : ''); ?>>Design</option>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="color" name="color" id="color" value="<?php echo e(old('color', '#667eea')); ?>"
                        ...
                        <div>
                            ...
                            <textarea name="requirements_text" id="requirements_text" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Minimum 10 sales&#10;Average rating 4.5+&#10;Active for 6 months"><?php echo e(old('requirements_text')); ?></textarea>
                            <p class="mt-1 text-sm text-gray-500">Enter one requirement per line. These will be converted to an array.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="benefits" id="benefits" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('benefits')); ?></textarea>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="requires_application" value="1" <?php echo e(old('requires_application', true) ? 'checked' : ''); ?>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="requires_approval" value="1" <?php echo e(old('requires_approval', true) ? 'checked' : ''); ?>
...
<script>
document.getElementById('requirements_text').addEventListener('input', function() {
    // Convert textarea to array format for backend
    const lines = this.value.split('\n').filter(line => line.trim());
    // Store in hidden field or process on submit
});
</script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\certifications\create.blade.php ENDPATH**/ ?>