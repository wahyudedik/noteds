            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    ...
                    <a href="<?php echo e(route('admin.users.pending-verification')); ?>"
                        ...
                        <span
                            class="text-sm font-medium text-yellow-900"><?php echo e(__('messages.verification_pending_title')); ?></span>
                    ...
                    <a href="<?php echo e(route('admin.leaderboard-settings.index')); ?>"
                        ...
                        <span class="text-sm font-medium text-violet-900"><?php echo e(__('messages.leaderboard')); ?></span>
                    </a>
                </div>
            </div>
