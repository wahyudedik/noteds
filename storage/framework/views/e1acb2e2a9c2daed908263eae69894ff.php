<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php echo e(__('messages.profile_information')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600">
            <?php echo e(__('messages.update_account_profile_info')); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        <?php echo e(__('messages.email_address_unverified')); ?>


                        <button form="send-verification" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            <?php echo e(__('messages.click_here_resend_verification')); ?>
                    ...
                    <?php if(session('status') === 'verification-link-sent'): ?>
                        <p class="mt-2 font-medium text-sm text-green-600">
                            <?php echo e(__('messages.new_verification_link_sent')); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('messages.save')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if(session('status') === 'profile-updated'): ?>
                ...
                ><?php echo e(__('messages.saved')); ?></p>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\profile\partials\update-profile-information-form.blade.php ENDPATH**/ ?>