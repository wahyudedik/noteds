<?php $__env->startSection('title', __('messages.create_support_ticket')); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.create_support_ticket')); ?></h1>
            </div>
            <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.report_issue_request_assistance')); ?></p>
        </div>

        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
            <form action="<?php echo e(route('support-tickets.store')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="title" id="title" value="<?php echo e(old('title')); ?>" required
                        placeholder="<?php echo e(__('messages.brief_description_issue')); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <!-- Priority -->
                <div class="mb-6" x-data="{ priority: '<?php echo e(old('priority', 'low')); ?>' }">
                    <label for="priority" class="flex items-center gap-2 text-sm font-semibold text-blue-700 mb-2">
                        <span class="inline-flex items-center gap-2">
                            ...
                            <span><?php echo e(__('messages.priority')); ?></span>
                        </span>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <label
                            ...
                            <span><?php echo e(__('messages.low')); ?></span>
                        </label>
                        <label
                            class="relative flex cursor-pointer items-center justify-center rounded-xl border-2 p-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-offset-1"
                            ...
                            <span><?php echo e(__('messages.medium')); ?></span>
                        </label>
                        <label
                            class="relative flex cursor-pointer items-center justify-center rounded-xl border-2 p-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-offset-1"
                            :class="priority === 'high'
                            ...
                            <span><?php echo e(__('messages.high')); ?></span>
                        </label>
                        <label
                            class="relative flex cursor-pointer items-center justify-center rounded-xl border-2 p-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-offset-1"
                            ...
                            <span><?php echo e(__('messages.urgent')); ?></span>
                        </label>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="8" required
                        placeholder="<?php echo e(__('messages.provide_detailed_information')); ?>"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.minimum_characters_detailed')); ?></p>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="links" id="links" value="<?php echo e(old('links')); ?>"
                        placeholder="<?php echo e(__('messages.paste_urls_separated')); ?>"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition-all duration-200">
...
unset($__errorArgs, $__bag); ?>
                    <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.add_relevant_links')); ?></p>
                </div>

                <!-- Submit Button -->
                <div class="flex items-center justify-end gap-3">
                    <a href="<?php echo e(route('support-tickets.index')); ?>" class="px-4 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                        <?php echo e(__('messages.cancel')); ?>

                    </a>
                    <button type="submit" class="px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                        <?php echo e(__('messages.create_ticket')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\support-tickets\create.blade.php ENDPATH**/ ?>