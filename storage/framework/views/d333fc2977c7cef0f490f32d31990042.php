...
<head>
    ...
    <title>New Note from <?php echo e($seller->name); ?></title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb;">
        <h2 style="color: #1f2937; margin-top: 0; font-size: 24px;">
            New Note from <?php echo e($seller->name); ?>!
        </h2>
        
        <p style="font-size: 16px; color: #374151;">
            Hello <?php echo e($follower->name); ?>,
        </p>
        
        <p style="font-size: 16px; color: #374151;">
            <strong><?php echo e($seller->name); ?></strong> just published a new note that you might be interested in:
        </p>
        ...
        <p style="color: #6b7280; font-size: 14px; margin-top: 30px; border-top: 1px solid #e5e7eb; padding-top: 20px;">
            You're receiving this because you're following <?php echo e($seller->name); ?>. 
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\emails\new-note-following.blade.php ENDPATH**/ ?>