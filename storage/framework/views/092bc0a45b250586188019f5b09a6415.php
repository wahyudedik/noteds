<?php $__env->startSection('title', 'Subscribe to ' . $plan->name); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($plan->name); ?> Plan</h1>
                <p class="text-gray-600"><?php echo e($plan->description); ?></p>
            </div>
            ...
            <div class="text-center mb-8">
                <div id="monthly-price" class="price-display">
                    <span class="text-5xl font-bold text-gray-900"><?php echo e(currency($plan->monthly_price)); ?></span>
                    <span class="text-gray-600 ml-2">/month</span>
                </div>
                <div id="yearly-price" class="price-display hidden">
                    <span class="text-5xl font-bold text-gray-900"><?php echo e(currency($plan->yearly_price)); ?></span>
            ...
            <!-- Subscription Form -->
            <form id="subscribe-form" action="<?php echo e(route('subscriptions.subscribe', $plan)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                        ...
                        <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500 transition-colors payment-method">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-sm text-gray-600"><?php echo e(currency(auth()->user()->wallet_balance)); ?></span>
                                </div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="font-semibold text-gray-900"><?php echo e($plan->name); ?> (<span id="billing-cycle-text">Monthly</span>)</span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-gray-600">Total</span>
                        <span class="text-2xl font-bold text-gray-900" id="total-price"><?php echo e(currency($plan->monthly_price)); ?></span>
                    </div>
                </div>
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-gray-700">Exclusive discounts (<?php echo e(match($plan->slug) { 'basic' => '10%', 'pro' => '20%', 'enterprise' => '30%', default => '0%' }); ?>)</span>
                </div>
                <div class="flex items-center gap-3">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const monthlyPriceValue = <?php echo e($plan->monthly_price); ?>;
    const yearlyPriceValue = <?php echo e($plan->yearly_price); ?>;
    ...
    monthlyBtn.addEventListener('click', function() {
        ...
        totalPrice.textContent = '<?php echo e(currency($plan->monthly_price)); ?>';
    });
    ...
    yearlyBtn.addEventListener('click', function() {
        ...
        totalPrice.textContent = '<?php echo e(currency($plan->yearly_price)); ?>';
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\subscriptions\show.blade.php ENDPATH**/ ?>