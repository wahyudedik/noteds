...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['code' => null, 'language' => 'javascript', 'codeUrl' => null, 'demoLink' => null]));
...
foreach (array_filter((['code' => null, 'language' => 'javascript', 'codeUrl' => null, 'demoLink' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="mb-6">
    <div class="bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 rounded-xl border-2 border-blue-200 p-6 shadow-lg">
        <div class="flex items-center justify-between mb-4">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <?php if($language): ?>
                        <p class="text-xs text-gray-600">Language: <span class="font-semibold"><?php echo e(ucfirst($language)); ?></span></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php if($demoLink): ?>
                <a href="<?php echo e($demoLink); ?>" target="_blank" rel="noopener noreferrer"
        ...
        <div x-data="{ 
            code: <?php echo \Illuminate\Support\Js::from($code)->toHtml() ?>,
            language: <?php echo \Illuminate\Support\Js::from($language)->toHtml() ?>,
            loading: <?php echo e($codeUrl ? 'true' : 'false'); ?>,
            async loadCode() {
                if (!this.code && '<?php echo e($codeUrl); ?>') {
                    try {
                        const response = await fetch('<?php echo e($codeUrl); ?>');
        ...
        class="relative">
            <div class="bg-gray-900 rounded-lg overflow-hidden shadow-xl">
                <div class="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
                    ...
                    <span class="text-xs text-gray-400 font-mono"><?php echo e($language ?? 'code'); ?></span>
                </div>
                <div class="p-4 overflow-x-auto max-h-96">
                    <pre x-show="!loading" class="text-sm text-gray-100 font-mono"><code class="language-<?php echo e($language ?? 'javascript'); ?>" x-text="code || 'No code preview available.'"></code></pre>
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\components\rich-media\code-preview.blade.php ENDPATH**/ ?>