...
<?php $__env->startSection('title', isset($pointsPricingConfig) ? 'Edit Pricing Configuration' : 'Create Pricing Configuration'); ?>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mt-2">
                <?php echo e(isset($pointsPricingConfig) ? 'Edit Pricing Configuration' : 'Create New Pricing Configuration'); ?>
        ...
        <div class="max-w-2xl mx-auto">
            <form
                action="<?php echo e(isset($pointsPricingConfig) ? route('admin.points-pricing.update', $pointsPricingConfig) : route('admin.points-pricing.store')); ?>"
                method="POST" class="bg-white rounded-lg shadow p-8">
                <?php echo csrf_field(); ?>
                <?php if(isset($pointsPricingConfig)): ?>
                ...
                <div class="mb-6">
                    ...
                    <select name="type" id="type" required onchange="updateTypeFields()"
                        ...
                        <option value="discount"
                            <?php echo e(old('type', $pointsPricingConfig->type ?? '') === 'discount' ? 'selected' : ''); ?>>Discount
                            (on purchases)</option>
                        <option value="premium_feature"
                            <?php echo e(old('type', $pointsPricingConfig->type ?? '') === 'premium_feature' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="points_required" id="points_required"
                        value="<?php echo e(old('points_required', $pointsPricingConfig->points_required ?? 100)); ?>" min="1"
                        required
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="datetime-local" name="expires_at" id="expires_at"
                        value="<?php echo e(old('expires_at', isset($pointsPricingConfig) && $pointsPricingConfig->expires_at ? $pointsPricingConfig->expires_at->format('Y-m-d\TH:i') : '')); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1"
                            <?php echo e(old('is_active', $pointsPricingConfig->is_active ?? true) ? 'checked' : ''); ?>
                ...
                <div class="flex gap-4">
                    <button type="submit"
                        ...
                        <?php echo e(isset($pointsPricingConfig) ? 'Update' : 'Create'); ?> Configuration
                    </button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\points-pricing\create.blade.php ENDPATH**/ ?>