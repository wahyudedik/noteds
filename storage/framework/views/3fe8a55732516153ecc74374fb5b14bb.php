...
<?php $__env->startSection('content'); ?>
                ...
                <div class="p-8">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-6">
                        ...
                        <div
                            ...
                            <?php else: ?>
                                <span
                                    class="text-4xl font-bold text-white"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></span>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="flex-1">
                            ...
                            <?php if($user->bio): ?>
                                <p class="text-base text-gray-600 mb-3"><?php echo e($user->bio); ?></p>
                            <?php endif; ?>
                        ...
                        <div class="flex flex-col items-end gap-3">
                            <div class="flex flex-wrap items-center gap-2 justify-end">
                                ...
                                <?php if($user->current_seller_level): ?>
                                    <div class="relative inline-block group">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold 
                                            <?php if($user->current_seller_level->color === 'bronze'): ?> bg-gradient-to-r from-orange-600 to-amber-700 text-white shadow-md
                                            <?php elseif($user->current_seller_level->color === 'silver'): ?> bg-gradient-to-r from-gray-300 to-gray-400 text-gray-900 shadow-md
                                            <?php elseif($user->current_seller_level->color === 'gold'): ?> bg-gradient-to-r from-yellow-400 to-orange-500 text-white shadow-md
                                            <?php elseif($user->current_seller_level->color === 'platinum'): ?> bg-gradient-to-r from-gray-400 to-gray-600 text-white shadow-md
                                            <?php elseif($user->current_seller_level->color === 'diamond'): ?> bg-gradient-to-r from-cyan-400 to-blue-500 text-white shadow-md
                                            <?php else: ?> bg-gray-100 text-gray-800
                                            <?php endif; ?>"
                                            title="<?php echo e($user->current_seller_level->name); ?>">
                                            <?php if($user->current_seller_level->icon): ?>
                                                <span class="mr-1"><?php echo e($user->current_seller_level->icon); ?></span>
                                            <?php endif; ?>
                                            <?php echo e($user->current_seller_level->name); ?>
                                        ...
                                        <div class="absolute right-0 bottom-full mb-2 hidden group-hover:block w-64 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg z-50">
                                            <div class="font-semibold mb-1"><?php echo e($user->current_seller_level->name); ?></div>
                                            <p class="text-gray-300 mb-2"><?php echo e($user->current_seller_level->description); ?></p>
                                            <?php if($user->current_seller_level->benefits_array): ?>
                                                <div class="mt-2 pt-2 border-t border-gray-700">
                                                    <p class="font-semibold mb-1">Benefits:</p>
                                                    <ul class="list-disc list-inside text-gray-300 space-y-1">
                                                        <?php $__currentLoopData = $user->current_seller_level->benefits_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php endif; ?>
                                <?php if($user->current_buyer_level): ?>
                                    <div class="relative inline-block group">
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold 
                                            <?php if($user->current_buyer_level->color === 'blue'): ?> bg-blue-100 text-blue-800
                                            <?php elseif($user->current_buyer_level->color === 'green'): ?> bg-green-100 text-green-800
                                            <?php elseif($user->current_buyer_level->color === 'purple'): ?> bg-purple-100 text-purple-800
                                            <?php elseif($user->current_buyer_level->color === 'gold'): ?> bg-gradient-to-r from-yellow-400 to-orange-500 text-white shadow-md
                                            <?php elseif($user->current_buyer_level->color === 'diamond'): ?> bg-gradient-to-r from-cyan-400 to-blue-500 text-white shadow-md
                                            <?php else: ?> bg-gray-100 text-gray-800
                                            <?php endif; ?>"
                                            title="<?php echo e($user->current_buyer_level->name); ?>">
                                            <?php if($user->current_buyer_level->icon): ?>
                                                <span class="mr-1"><?php echo e($user->current_buyer_level->icon); ?></span>
                                            <?php endif; ?>
                                            <?php echo e($user->current_buyer_level->name); ?>

                                        </span>
                                        <!-- Tooltip -->
                                        <div class="absolute right-0 bottom-full mb-2 hidden group-hover:block w-64 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg z-50">
                                            <div class="font-semibold mb-1"><?php echo e($user->current_buyer_level->name); ?></div>
                                            <p class="text-gray-300 mb-2"><?php echo e($user->current_buyer_level->description); ?></p>
                                            <?php if($user->current_buyer_level->benefits_array): ?>
                                                <div class="mt-2 pt-2 border-t border-gray-700">
                                                    <p class="font-semibold mb-1">Benefits:</p>
                                                    <ul class="list-disc list-inside text-gray-300 space-y-1">
                                                        <?php $__currentLoopData = $user->current_buyer_level->benefits_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $benefit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><?php echo e($benefit); ?></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                ...
                                <?php if($user->badges->count() > 0): ?>
                                    <?php $__currentLoopData = $user->badges->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $badge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="relative inline-block group">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold 
                                                <?php if($badge->color === 'gold'): ?> bg-gradient-to-r from-yellow-400 to-orange-500 text-white shadow-md
                                                <?php elseif($badge->color === 'green'): ?> bg-green-100 text-green-800
                                                <?php elseif($badge->color === 'blue'): ?> bg-blue-100 text-blue-800
                                                <?php elseif($badge->color === 'purple'): ?> bg-purple-100 text-purple-800
                                                <?php elseif($badge->color === 'yellow'): ?> bg-yellow-100 text-yellow-800
                                                <?php elseif($badge->color === 'orange'): ?> bg-orange-100 text-orange-800
                                                <?php else: ?> bg-gray-100 text-gray-800
                                                <?php endif; ?>"
                                                title="<?php echo e($badge->name); ?>">
                                                <?php if($badge->icon): ?>
                                                    <span class="mr-1"><?php echo e($badge->icon); ?></span>
                                                <?php endif; ?>
                                            ...
                                            <!-- Tooltip -->
                                            <div class="absolute right-0 bottom-full mb-2 hidden group-hover:block w-64 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg z-50">
                                                <div class="font-semibold mb-1"><?php echo e($badge->name); ?></div>
                                                <p class="text-gray-300"><?php echo e($badge->description); ?></p>
                                                <div class="absolute right-4 top-full w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-900"></div>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($user->badges->count() > 5): ?>
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-600">
                                            +<?php echo e($user->badges->count() - 5); ?> more
                                        </span>
                                    <?php endif; ?>
                                <?php endif; ?>

                                
                                <?php if($user->approvedCertifications && $user->approvedCertifications->count() > 0): ?>
                                    <?php $__currentLoopData = $user->approvedCertifications->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userCertification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="relative inline-block group">
                                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold border-2"
                                                style="background-color: <?php echo e($cert->color); ?>20; border-color: <?php echo e($cert->color); ?>; color: <?php echo e($cert->color); ?>;"
                                                title="<?php echo e($cert->name); ?>">
                                                <?php if($cert->icon): ?>
                                                    <span class="mr-1"><?php echo e($cert->icon); ?></span>
                                                <?php endif; ?>
                                            ...
                                            <!-- Tooltip -->
                                            <div class="absolute right-0 bottom-full mb-2 hidden group-hover:block w-64 p-3 bg-gray-900 text-white text-xs rounded-lg shadow-lg z-50">
                                                <div class="font-semibold mb-1"><?php echo e($cert->name); ?></div>
                                                <p class="text-gray-300 mb-2"><?php echo e($cert->description); ?></p>
                                                <?php if($cert->benefits): ?>
                                                    <div class="mt-2 pt-2 border-t border-gray-700">
                                                        <p class="font-semibold mb-1">Benefits:</p>
                                                        <p class="text-gray-300"><?php echo e($cert->benefits); ?></p>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($userCertification->approved_at): ?>
                                                    <div class="mt-2 pt-2 border-t border-gray-700 text-gray-400">
                                                        Certified: <?php echo e($userCertification->approved_at->format('M Y')); ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($user->approvedCertifications->count() > 5): ?>
                                        <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-600"
                                            title="View all certifications">
                                            +<?php echo e($user->approvedCertifications->count() - 5); ?> more
                                        </span>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <!-- Facebook -->
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode($profileUrl)); ?>"
                                ...
                                <!-- Twitter -->
                                <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode($profileUrl)); ?>&text=<?php echo e($profileTitle); ?>"
                                    target="_blank" rel="noopener noreferrer"
                                ...
                                <!-- WhatsApp -->
                                <a href="https://wa.me/?text=<?php echo e($profileTitle); ?>%20<?php echo e(urlencode($profileUrl)); ?>"
                                    target="_blank" rel="noopener noreferrer"
                                ...
                                <!-- LinkedIn -->
                                <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo e(urlencode($profileUrl)); ?>"
                                    target="_blank" rel="noopener noreferrer"
                                ...
                                <!-- Copy Link -->
                                <button onclick="copyToClipboard('<?php echo e($profileUrl); ?>')"
                                ...
                                <?php if(auth()->guard()->check()): ?>
                                    <?php if(auth()->id() !== $user->id): ?>
                                        <?php if(auth()->user()->isFollowing($user)): ?>
                                            <form action="<?php echo e(route('follow.unfollow', $user)); ?>" method="POST" class="inline-flex">
                                                <?php echo csrf_field(); ?>
                                        ...
                                        <?php else: ?>
                                            <form action="<?php echo e(route('follow.follow', $user)); ?>" method="POST" class="inline-flex">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_notes']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_sales']); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500"><?php echo e(__('messages.average_rating')); ?></p>
                            <p class="text-2xl font-bold text-gray-900">
                                <?php if($stats['average_rating'] > 0): ?>
                                    <?php echo e($stats['average_rating']); ?> / 5
                                <?php else: ?>
                                    N/A
                                <?php endif; ?>
                            </p>
                            <p class="text-xs text-gray-500"><?php echo e($stats['total_reviews']); ?>

                                <?php echo e($stats['total_reviews'] == 1 ? __('messages.review') : __('messages.reviews_count')); ?>
                ...
                <div
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <p class="text-sm font-medium text-gray-500"><?php echo e(__('messages.total_revenue')); ?></p>
                            <p class="text-2xl font-bold text-gray-900">
                                <?php echo e(currency($stats['total_revenue'])); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 mb-8">
                <div class="border-b border-gray-200">
                    <nav class="flex -mb-px" aria-label="Tabs">
                        <button onclick="showTab('notes')" id="tab-notes"
                            ...
                            <?php echo e(__('messages.public_notes')); ?> (<?php echo e($stats['total_notes']); ?>)
                        </button>
                        <button onclick="showTab('posts')" id="tab-posts"
                            ...
                            Forum Posts (<?php echo e($stats['total_posts']); ?>)
                        </button>
                    </nav>
                </div>
                ...
                <div id="tab-content-notes" class="tab-content">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('messages.public_notes')); ?></h2>
                            <p class="text-sm text-gray-600 mt-1">All notes published by <?php echo e($user->name); ?></p>
                        </div>
                        <?php if($publicNotes->count() > 0): ?>
                            <a href="<?php echo e(route('marketplace.index', ['seller' => $user->id])); ?>"
                    ...
                    <div class="p-6">
                        <?php if($publicNotes->count() > 0): ?>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                <?php $__currentLoopData = $publicNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div
                                        ...
                                        <div class="p-6">
                                            <div class="mb-4">
                                                ...
                                                <p class="text-sm text-gray-600 line-clamp-3"><?php echo Str::limit(strip_tags($note->content), 100); ?></p>
                                            </div>
                                            ...
                                            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                                <?php if($note->average_rating > 0): ?>
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <?php endfor; ?>
                                                        <span class="text-xs text-gray-600"><?php echo e($note->average_rating); ?></span>
                                                    </div>
                                                <?php endif; ?>
                                                <?php if($note->price > 0): ?>
                                                    <span class="text-sm font-semibold text-yellow-600">
                                                        <?php echo e(currency($note->price)); ?></span>
                                                <?php else: ?>
                                                    <span class="text-xs text-gray-500"><?php echo e(__('messages.free')); ?></span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php else: ?>
                            <div class="text-center py-12">
                                ...
                                <h3 class="mt-4 text-lg font-medium text-gray-900"><?php echo e(__('messages.no_public_notes_yet')); ?>

                                </h3>
                                <p class="mt-2 text-sm text-gray-500"><?php echo e(__('messages.user_hasnt_published_notes')); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div id="tab-content-posts" class="tab-content hidden">
                    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                        ...
                        <p class="text-sm text-gray-600 mt-1">All forum posts by <?php echo e($user->name); ?></p>
                    </div>
                    <div class="p-6">
    ...
    <?php $__env->startPush('scripts'); ?>
        <script>
            ...
            const accountReportEndpoint = "<?php echo e(route('users.report', $user)); ?>";
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\public\profile\show.blade.php ENDPATH**/ ?>