<?php $__env->startSection('title', __('messages.admin_faqs')); ?>

<?php $__env->startSection('content'); ?>
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900"><?php echo e(__('messages.faqs_management')); ?></h2>
            <div class="flex gap-4">
                <a href="<?php echo e(route('faq')); ?>" class="text-blue-600 hover:text-blue-800" target="_blank"><?php echo e(__('messages.view_public_faq')); ?></a>
        ...
        <div class="mb-6">
            <a href="<?php echo e(route('admin.faqs.create')); ?>" 
                ...
                <?php echo e(__('messages.add_new_faq')); ?>
        ...
        <?php if($faqs->isEmpty()): ?>
            <div class="bg-white shadow-sm rounded-lg p-12 text-center">
                ...
                <p class="mt-2 text-gray-600"><?php echo e(__('messages.create_first_faq')); ?></p>
                <a href="<?php echo e(route('admin.faqs.create')); ?>" class="mt-4 inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-200">
                    <?php echo e(__('messages.add_faq')); ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"><?php echo e(__('messages.question')); ?></th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="<?php echo e(!$faq->is_active ? 'bg-gray-50' : ''); ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($faq->created_at->format('M d, Y')); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="<?php echo e(route('admin.faqs.edit', $faq)); ?>" class="text-blue-600 hover:text-blue-900">
                                                <?php echo e(__('messages.edit')); ?>

                                            </a>
                                            <form action="<?php echo e(route('admin.faqs.destroy', $faq)); ?>" method="POST" class="inline delete-faq-form">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\faqs\index.blade.php ENDPATH**/ ?>