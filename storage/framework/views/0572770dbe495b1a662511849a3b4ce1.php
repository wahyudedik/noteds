...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['pdfUrl', 'filename' => null]));
...
foreach (array_filter((['pdfUrl', 'filename' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <?php if($filename): ?>
                    <p class="text-xs text-gray-600 truncate"><?php echo e($filename); ?></p>
                <?php endif; ?>
            </div>
        </div>
        <a href="<?php echo e($pdfUrl); ?>" download
    ...
    <div 
        x-data="{
            ...
            async loadPDF() {
                ...
                try {
                    // Load PDF using PDF.js
                    const loadingTask = pdfjsLib.getDocument('<?php echo e($pdfUrl); ?>');
        ...
        <div class="relative bg-gray-900 min-h-[500px] flex items-center justify-center overflow-auto">
            ...
            <div x-show="error" class="text-center text-gray-400 p-8">
                ...
                <a href="<?php echo e($pdfUrl); ?>" download class="inline-block px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors">
                    Download PDF
                </a>
            </div>
            <canvas 
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\components\rich-media\pdf-preview.blade.php ENDPATH**/ ?>