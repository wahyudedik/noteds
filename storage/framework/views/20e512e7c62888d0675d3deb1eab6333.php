<?php $__env->startSection('title', __('messages.edit_note')); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-2">
                <a href="<?php echo e(route('notes.index')); ?>" class="text-gray-500 hover:text-gray-700 mr-2">
                    <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </a>
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.edit_note')); ?></h1>
            </div>
            <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.update_note_information')); ?></p>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                <h2 class="text-lg font-semibold text-gray-900"><?php echo e(__('messages.note_details')); ?></h2>
            </div>
            <div class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="<?php echo e(old('title', $note->title)); ?>" required
                            :placeholder="__('messages.enter_note_title')"
                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="ecosystem_category" id="ecosystem_category"
                            ...
                            <?php $__currentLoopData = $ecosystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($key); ?>" <?php echo e(old('ecosystem_category', $note->ecosystem_category)===$key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['ecosystem_category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div id="code-fields" class="hidden p-4 bg-blue-50 border border-blue-200 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="code_language" id="code_language" value="<?php echo e(old('code_language', $note->code_language)); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="code_framework" id="code_framework" value="<?php echo e(old('code_framework', $note->code_framework)); ?>"
                                ...
                                <div>
                                    ...
                                    <select name="code_type" id="code_type"
                                        ...
                                        <option value="plugin" <?php echo e(old('code_type', $note->code_type) === 'plugin' ? 'selected' : ''); ?>>Plugin</option>
                                        <option value="script" <?php echo e(old('code_type', $note->code_type) === 'script' ? 'selected' : ''); ?>>Script</option>
                                        <option value="library" <?php echo e(old('code_type', $note->code_type) === 'library' ? 'selected' : ''); ?>>Library</option>
                                        <option value="component" <?php echo e(old('code_type', $note->code_type) === 'component' ? 'selected' : ''); ?>>Component</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="code_demo_link" id="code_demo_link" value="<?php echo e(old('code_demo_link', $note->code_demo_link)); ?>"
                                ...
                                <?php $__errorArgs = ['code_demo_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div id="photo-fields" class="hidden p-4 bg-green-50 border border-green-200 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="photo_resolution" id="photo_resolution" value="<?php echo e(old('photo_resolution', $note->photo_resolution)); ?>"
                                ...
                                <div>
                                    ...
                                    <select name="photo_type" id="photo_type"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500">
                                        <option value="">Pilih Tipe</option>
                                        <option value="stock" <?php echo e(old('photo_type', $note->photo_type) === 'stock' ? 'selected' : ''); ?>>Stock</option>
                                        <option value="portrait" <?php echo e(old('photo_type', $note->photo_type) === 'portrait' ? 'selected' : ''); ?>>Portrait</option>
                                        <option value="landscape" <?php echo e(old('photo_type', $note->photo_type) === 'landscape' ? 'selected' : ''); ?>>Landscape</option>
                                        <option value="product" <?php echo e(old('photo_type', $note->photo_type) === 'product' ? 'selected' : ''); ?>>Product</option>
                                        <option value="event" <?php echo e(old('photo_type', $note->photo_type) === 'event' ? 'selected' : ''); ?>>Event</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="photo_format" id="photo_format"
                                        ...
                                        <option value="jpeg" <?php echo e(old('photo_format', $note->photo_format) === 'jpeg' ? 'selected' : ''); ?>>JPEG</option>
                                        <option value="jpg" <?php echo e(old('photo_format', $note->photo_format) === 'jpg' ? 'selected' : ''); ?>>JPG</option>
                                        <option value="png" <?php echo e(old('photo_format', $note->photo_format) === 'png' ? 'selected' : ''); ?>>PNG</option>
                                        <option value="raw" <?php echo e(old('photo_format', $note->photo_format) === 'raw' ? 'selected' : ''); ?>>RAW</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="photo_gallery_link" id="photo_gallery_link" value="<?php echo e(old('photo_gallery_link', $note->photo_gallery_link)); ?>"
                                ...
                                <?php $__errorArgs = ['photo_gallery_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="design_type" id="design_type"
                                        ...
                                        <option value="">Pilih Tipe</option>
                                        <option value="logo" <?php echo e(old('design_type', $note->design_type) === 'logo' ? 'selected' : ''); ?>>Logo</option>
                                        <option value="flyer" <?php echo e(old('design_type', $note->design_type) === 'flyer' ? 'selected' : ''); ?>>Flyer</option>
                                        <option value="icon" <?php echo e(old('design_type', $note->design_type) === 'icon' ? 'selected' : ''); ?>>Icon</option>
                                        <option value="illustration" <?php echo e(old('design_type', $note->design_type) === 'illustration' ? 'selected' : ''); ?>>Illustration</option>
                                        <option value="print" <?php echo e(old('design_type', $note->design_type) === 'print' ? 'selected' : ''); ?>>Print</option>
                                        <option value="branding" <?php echo e(old('design_type', $note->design_type) === 'branding' ? 'selected' : ''); ?>>Branding</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="design_format" id="design_format"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
                                        <option value="">Pilih Format</option>
                                        <option value="ai" <?php echo e(old('design_format', $note->design_format) === 'ai' ? 'selected' : ''); ?>>AI (Illustrator)</option>
                                        <option value="psd" <?php echo e(old('design_format', $note->design_format) === 'psd' ? 'selected' : ''); ?>>PSD (Photoshop)</option>
                                        <option value="eps" <?php echo e(old('design_format', $note->design_format) === 'eps' ? 'selected' : ''); ?>>EPS</option>
                                        <option value="pdf" <?php echo e(old('design_format', $note->design_format) === 'pdf' ? 'selected' : ''); ?>>PDF</option>
                                        <option value="svg" <?php echo e(old('design_format', $note->design_format) === 'svg' ? 'selected' : ''); ?>>SVG</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="design_preview_link" id="design_preview_link" value="<?php echo e(old('design_preview_link', $note->design_preview_link)); ?>"
                                ...
                                <?php $__errorArgs = ['design_preview_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div id="audio-fields" class="hidden p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="number" name="audio_duration" id="audio_duration" value="<?php echo e(old('audio_duration', $note->audio_duration)); ?>"
                                ...
                                <div>
                                    ...
                                    <select name="audio_format" id="audio_format"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500">
                                        <option value="">Pilih Format</option>
                                        <option value="mp3" <?php echo e(old('audio_format', $note->audio_format) === 'mp3' ? 'selected' : ''); ?>>MP3</option>
                                        <option value="wav" <?php echo e(old('audio_format', $note->audio_format) === 'wav' ? 'selected' : ''); ?>>WAV</option>
                                        <option value="flac" <?php echo e(old('audio_format', $note->audio_format) === 'flac' ? 'selected' : ''); ?>>FLAC</option>
                                        <option value="aac" <?php echo e(old('audio_format', $note->audio_format) === 'aac' ? 'selected' : ''); ?>>AAC</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="audio_genre" id="audio_genre" value="<?php echo e(old('audio_genre', $note->audio_genre)); ?>"
                            ...
                            <div>
                                ...
                                <input type="url" name="audio_link" id="audio_link" value="<?php echo e(old('audio_link', $note->audio_link)); ?>"
                        ...
                        <div id="video-fields" class="hidden p-4 bg-red-50 border border-red-200 rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="number" name="video_duration" id="video_duration" value="<?php echo e(old('video_duration', $note->video_duration)); ?>"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="video_resolution" id="video_resolution" value="<?php echo e(old('video_resolution', $note->video_resolution)); ?>"
                                        placeholder="1920x1080, 4K, dll"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500">
                                </div>
                                <div>
                                    ...
                                    <select name="video_format" id="video_format"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500">
                                        <option value="">Pilih Format</option>
                                        <option value="mp4" <?php echo e(old('video_format', $note->video_format) === 'mp4' ? 'selected' : ''); ?>>MP4</option>
                                        <option value="mov" <?php echo e(old('video_format', $note->video_format) === 'mov' ? 'selected' : ''); ?>>MOV</option>
                                        <option value="avi" <?php echo e(old('video_format', $note->video_format) === 'avi' ? 'selected' : ''); ?>>AVI</option>
                                        <option value="webm" <?php echo e(old('video_format', $note->video_format) === 'webm' ? 'selected' : ''); ?>>WebM</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="video_link" id="video_link" value="<?php echo e(old('video_link', $note->video_link)); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="theme_platform" id="theme_platform"
                                        ...
                                        <option value="wordpress" <?php echo e(old('theme_platform', $note->theme_platform) === 'wordpress' ? 'selected' : ''); ?>>WordPress</option>
                                        <option value="shopify" <?php echo e(old('theme_platform', $note->theme_platform) === 'shopify' ? 'selected' : ''); ?>>Shopify</option>
                                        <option value="html" <?php echo e(old('theme_platform', $note->theme_platform) === 'html' ? 'selected' : ''); ?>>HTML</option>
                                        <option value="drupal" <?php echo e(old('theme_platform', $note->theme_platform) === 'drupal' ? 'selected' : ''); ?>>Drupal</option>
                                        <option value="magento" <?php echo e(old('theme_platform', $note->theme_platform) === 'magento' ? 'selected' : ''); ?>>Magento</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="theme_type" id="theme_type"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                                        <option value="">Pilih Tipe</option>
                                        <option value="business" <?php echo e(old('theme_type', $note->theme_type) === 'business' ? 'selected' : ''); ?>>Business</option>
                                        <option value="ecommerce" <?php echo e(old('theme_type', $note->theme_type) === 'ecommerce' ? 'selected' : ''); ?>>E-commerce</option>
                                        <option value="blog" <?php echo e(old('theme_type', $note->theme_type) === 'blog' ? 'selected' : ''); ?>>Blog</option>
                                        <option value="portfolio" <?php echo e(old('theme_type', $note->theme_type) === 'portfolio' ? 'selected' : ''); ?>>Portfolio</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="theme_preview_link" id="theme_preview_link" value="<?php echo e(old('theme_preview_link', $note->theme_preview_link)); ?>"
                                ...
                                <?php $__errorArgs = ['theme_preview_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="three_d_format" id="three_d_format"
                                        ...
                                        <option value="">Pilih Format</option>
                                        <option value="obj" <?php echo e(old('three_d_format', $note->three_d_format) === 'obj' ? 'selected' : ''); ?>>OBJ</option>
                                        <option value="fbx" <?php echo e(old('three_d_format', $note->three_d_format) === 'fbx' ? 'selected' : ''); ?>>FBX</option>
                                        <option value="blend" <?php echo e(old('three_d_format', $note->three_d_format) === 'blend' ? 'selected' : ''); ?>>Blend</option>
                                        <option value="dae" <?php echo e(old('three_d_format', $note->three_d_format) === 'dae' ? 'selected' : ''); ?>>DAE</option>
                                        <option value="3ds" <?php echo e(old('three_d_format', $note->three_d_format) === '3ds' ? 'selected' : ''); ?>>3DS</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="three_d_type" id="three_d_type"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500">
                                        <option value="">Pilih Tipe</option>
                                        <option value="model" <?php echo e(old('three_d_type', $note->three_d_type) === 'model' ? 'selected' : ''); ?>>Model</option>
                                        <option value="texture" <?php echo e(old('three_d_type', $note->three_d_type) === 'texture' ? 'selected' : ''); ?>>Texture</option>
                                        <option value="rig" <?php echo e(old('three_d_type', $note->three_d_type) === 'rig' ? 'selected' : ''); ?>>Rig</option>
                                        <option value="animation" <?php echo e(old('three_d_type', $note->three_d_type) === 'animation' ? 'selected' : ''); ?>>Animation</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                ...
                                <input type="url" name="three_d_preview_link" id="three_d_preview_link" value="<?php echo e(old('three_d_preview_link', $note->three_d_preview_link)); ?>"
                                ...
                                <?php $__errorArgs = ['three_d_preview_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" class="hidden" required><?php echo e(old('content', $note->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label for="summary" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e(__('messages.summary')); ?> <span
                                class="text-xs text-gray-500">(Optional)</span>
                        </label>
                        <textarea name="summary" id="summary" rows="3"
                            placeholder="<?php echo e(__('messages.auto_generated_summary_placeholder')); ?>"
                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 resize-y <?php $__errorArgs = ['summary'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('summary', $note->summary)); ?></textarea>
                        <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.brief_summary_note')); ?></p>
                        ...
                        <div>
                            ...
                            <select name="language" id="language"
                                ...
                                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($code); ?>" <?php echo e(old('language', $note->language)===$code ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="scheduled_publish_at" id="scheduled_publish_at" value="<?php echo e(old('scheduled_publish_at', optional($note->scheduled_publish_at)->format('Y-m-d\TH:i'))); ?>"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200">
                            <p class="mt-2 text-xs text-gray-600">Jika diisi, catatan akan otomatis dipublikasikan pada waktu tersebut.</p>
                            <?php $__errorArgs = ['scheduled_publish_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(old('price', $note->price) > 0): ?>
                    <div id="preview-content-wrapper">
                        <label for="preview_content" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e(__('messages.preview_content')); ?> <span class="text-xs text-gray-500"><?php echo e(__('messages.preview_content_optional')); ?></span>
                        </label>
                        <textarea name="preview_content" id="preview_content" rows="3" maxlength="300"
                            placeholder="<?php echo e(__('messages.enter_preview_for_buyers')); ?>"
                            class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 resize-y <?php $__errorArgs = ['preview_content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('preview_content', $note->preview_content)); ?></textarea>
                        <p class="mt-1 text-xs text-gray-500">
                            <span id="preview-char-count"><?php echo e(strlen(old('preview_content', $note->preview_content))); ?></span>/300 <?php echo e(__('messages.characters')); ?>. 
                            <?php if(empty(old('preview_content', $note->preview_content))): ?> <?php echo e(__('messages.auto_generated_from_content')); ?> <?php endif; ?>
                        </p>
                        <?php $__errorArgs = ['preview_content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="flex items-center gap-4">
                                <input type="range" name="preview_percentage" id="preview_percentage" 
                                    min="0" max="100" step="5" value="<?php echo e(old('preview_percentage', $note->preview_percentage ?? 0)); ?>"
                                    class="flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600">
                                <div class="w-20 text-center">
                                    <span id="preview-percentage-value" class="text-lg font-semibold text-blue-600"><?php echo e(old('preview_percentage', $note->preview_percentage ?? 0)); ?></span>
                            ...
                            <?php $__errorArgs = ['preview_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <?php if($note->hasVideoPreview()): ?>
                            <div class="mb-3 bg-gray-50 border border-gray-200 rounded-lg p-4">
                                ...
                                <?php if($note->video_preview_duration): ?>
                                    <p class="mt-2 text-xs text-gray-600">Durasi: <?php echo e(gmdate('i:s', $note->video_preview_duration)); ?></p>
                                <?php endif; ?>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 justify-center items-center">
                                    <label for="video_preview"
                                        ...
                                        <span><?php echo e($note->hasVideoPreview() ? 'Ganti video' : 'Upload video'); ?></span>
                    ...
                    <div id="thumbnail-wrapper" class="mt-6">
                        ...
                        <?php if($note->hasThumbnails()): ?>
                            <div class="mb-4 grid grid-cols-2 md:grid-cols-5 gap-4">
                                <?php $__currentLoopData = $note->thumbnails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $thumbnail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative group">
                                        <img src="<?php echo e(Storage::url($thumbnail)); ?>" alt="Thumbnail <?php echo e($index + 1); ?>" 
                                            class="w-full h-32 object-cover rounded-lg border-2 border-gray-200">
                                        <button type="button" onclick="removeExistingThumbnail('<?php echo e($thumbnail); ?>')" 
                                            class="absolute top-1 right-1 bg-red-500 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                            </svg>
                                        </button>
                                        <input type="hidden" name="removed_thumbnails[]" id="removed_thumbnail_<?php echo e($index); ?>" value="">
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($note->hasAttachments()): ?>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Current Attachments (<?php echo e($note->file_count); ?>)
                            </label>
                            <div class="space-y-2 mb-3">
                                <?php $__currentLoopData = $note->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        ...
                                        <div class="flex items-center flex-1 min-w-0">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <?php if(is_array($attachment) && isset($attachment['size'])): ?>
                                                    <p class="text-xs text-gray-500"><?php echo e(number_format($attachment['size'] / 1024, 2)); ?> KB</p>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <label class="ml-3 flex items-center cursor-pointer">
                                            <input type="checkbox" name="removed_attachments[]" value="<?php echo e($filename); ?>" class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
                                            <span class="ml-2 text-xs text-red-600"><?php echo e(__('messages.remove')); ?></span>
                                        </label>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                    ...
                    <div>
                        <label for="attachments" class="block text-sm font-medium text-gray-700 mb-2">
                            <?php echo e(__('messages.add_more_files')); ?>

                            <span class="text-xs text-gray-500 font-normal">
                                <?php echo e(__('messages.file_attachments_optional')); ?>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="attachments" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                        <span><?php echo e(__('messages.upload_files')); ?></span>
                                    ...
                                    <p class="pl-1"><?php echo e(__('messages.or_drag_and_drop')); ?></p>
                                </div>
                                <p class="text-xs text-gray-500">
                                    <?php if(auth()->user()->hasPremium()): ?>
                                        Maksimal 100MB per file
                                    <?php else: ?>
                                        <?php echo e(__('messages.max_5mb_per_file')); ?>
                        ...
                        <!-- Large Files Warning -->
                        <?php if(session('large_files_warning')): ?>
                                    ...
                                    <div class="ml-3 flex-1">
                                        ...
                                        <div class="mt-2 text-sm text-yellow-700">
                                            ...
                                            <ul class="mt-1 list-disc list-inside">
                                                <?php $__currentLoopData = session('large_files_warning'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if(session('upload_errors')): ?>
                            <div class="mt-2 p-3 bg-red-50 border border-red-200 rounded-lg">
                                <p class="text-sm font-medium text-red-800 mb-2">Upload errors:</p>
                                <ul class="list-disc list-inside text-sm text-red-700">
                                    <?php $__currentLoopData = session('upload_errors'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filename => $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><strong><?php echo e($filename); ?>:</strong> <?php echo e($error); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        <?php endif; ?>
                    ...
                    <div id="demo-link-wrapper" class="mt-6">
                        ...
                        <input type="url" 
                            name="demo_link" 
                            id="demo_link" 
                            value="<?php echo e(old('demo_link', $note->demo_link)); ?>"
                            placeholder="https://demo.example.com atau https://app.example.com/demo"
                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['demo_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea 
                            ...
                            class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['external_links'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <!-- Content Protection -->
                    <?php echo $__env->make('notes.partials.content-protection', ['note' => $note], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                    <!-- Price and Status -->
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="price" class="block text-sm font-medium text-gray-700 mb-2">
                                <?php echo e(__('messages.price')); ?> <span class="text-xs text-gray-500 font-normal"><?php echo e(__('messages.price_rp_0_for_free')); ?></span>
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span class="text-gray-500 sm:text-sm">Rp</span>
                                </div>
                                <input type="number" name="price" id="price" value="<?php echo e(old('price', $note->price)); ?>" min="0" step="0.01"
                                    placeholder="0"
                                    class="mt-1 block w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <div class="mt-2 flex items-start gap-2">
                                ...
                                <p class="text-xs text-gray-600">
                                    <strong class="text-green-700"><?php echo e(__('messages.free')); ?></strong>: <?php echo e(__('messages.share_knowledge_freely')); ?> • 
                                    <strong class="text-blue-700"><?php echo e(__('messages.paid')); ?></strong>: <?php echo e(__('messages.set_your_own_price')); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4 text-xs text-blue-800 space-y-2">
                                    <?php if(!empty($priceGuidance['min_default'])): ?>
                                        <p class="flex items-center gap-2">
                                            ...
                                            <span><?php echo __('messages.price_guidance_minimum_default', ['amount' => '<strong id="price-guidance-min-default">' . currency($priceGuidance['min_default']) . '</strong>']); ?></span>
                                        </p>
                                    <?php endif; ?>
                                    <p class="flex items-center gap-2 <?php echo e(empty($priceGuidance['recommended_price']) ? 'hidden' : ''); ?>" id="price-guidance-recommended-row">
                                        <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M5 13l4 4L19 7" />
                                        </svg>
                                        <span><?php echo __('messages.price_guidance_recommended', [
                                    ...
                                    <p class="flex items-center gap-2 hidden" id="price-guidance-selected-row">
                                        ...
                                        <span id="price-guidance-selected" data-template="<?php echo e(__('messages.price_guidance_selected_min', ['amount' => ':amount'])); ?>"></span>
                                    </p>
                                    <p class="text-xs font-semibold text-red-600 hidden" id="price-guidance-warning" data-template="<?php echo e(__('messages.price_guidance_warning_below', ['amount' => ':amount'])); ?>"></p>
                                    <?php if(!empty($priceGuidance['category_rules'])): ?>
                                        <div>
                                            <p class="font-semibold text-blue-900"><?php echo e(__('messages.price_guidance_category_heading')); ?></p>
                                            <ul class="mt-1 space-y-1 text-blue-700">
                                                <?php $__currentLoopData = $priceGuidance['category_rules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>• <?php echo __('messages.price_guidance_category_item', [
                            ...
                            <!-- Discount Price -->
                            <div class="mt-4" id="discount-price-wrapper" style="display: <?php echo e(old('discount_price', $note->discount_price) || old('price', $note->price) > 0 ? 'block' : 'none'); ?>;">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="discount_price" id="discount_price"
                                        value="<?php echo e(old('discount_price', $note->discount_price)); ?>" min="0" step="0.01" placeholder="0"
                                        class="mt-1 block w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['discount_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <div id="discount-preview" class="mt-2 text-sm text-gray-600 <?php echo e($note->hasDiscount() ? '' : 'hidden'); ?>">
                                    <span class="font-medium text-green-600">Diskon: <span id="discount-percent"><?php echo e($note->discount_percent ?? 0); ?></span>%</span>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="status" id="status"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <option value="active" <?php echo e(old('status', $note->status) === 'active' ? 'selected' : ''); ?>><?php echo e(__('messages.active')); ?></option>
                                <option value="sold" <?php echo e(old('status', $note->status) === 'sold' ? 'selected' : ''); ?>><?php echo e(__('messages.sold')); ?></option>
                                <option value="inactive" <?php echo e(old('status', $note->status) === 'inactive' ? 'selected' : ''); ?>><?php echo e(__('messages.inactive')); ?></option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="flex items-center p-4 rounded-lg border border-gray-200 hover:border-blue-300 cursor-pointer transition-colors duration-200">
                            <input type="checkbox" name="is_public" value="1" <?php echo e(old('is_public', $note->is_public) ? 'checked' : ''); ?>

                                class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-colors duration-200">
                            <div class="ml-3">
                                <span class="text-sm font-medium text-gray-700"><?php echo e(__('messages.make_public')); ?></span>
                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e(__('messages.available_in_marketplace')); ?></p>
                            </div>
                        </label>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                        <div>
                            <label for="folder_id" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <?php echo e(__('messages.folder_optional')); ?>
                            ...
                            <select name="folder_id" id="folder_id"
                                ...
                                <option value=""><?php echo e(__('messages.none_root')); ?></option>
                                <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($folder->id); ?>" <?php echo e(old('folder_id', $note->folder_id) == $folder->id ? 'selected' : ''); ?>>
                                        <?php echo e($folder->name); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.organize_notes_in_folders')); ?></p>
                        </div>
                        ...
                        <div>
                            <label for="workspace_id" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <?php echo e(__('messages.workspace_optional')); ?>

                            </label>
                            <select name="workspace_id" id="workspace_id"
                                class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
                                <option value=""><?php echo e(__('messages.personal')); ?></option>
                                <?php $__currentLoopData = $workspaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($workspace->id); ?>" <?php echo e(old('workspace_id', $note->workspace_id) == $workspace->id ? 'selected' : ''); ?>>
                                        <?php echo e($workspace->name); ?> (<?php echo e($workspace->type); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.assign_to_workspace')); ?></p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2 mb-3 min-h-[2.5rem] p-2 border border-gray-200 rounded-lg bg-gray-50" id="tags-container">
                            <?php if(old('tags')): ?>
                                <?php $__currentLoopData = old('tags'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div>
                                <input type="text" id="tag-input" placeholder="<?php echo e(__('messages.type_tag_and_press_enter')); ?>" 
                            ...
                            <div>
                                <select id="tag-select" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200">
                                    <option value=""><?php echo e(__('messages.select_existing_tag')); ?></option>
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tag->name); ?>"><?php echo e($tag->name); ?> (<?php echo e($tag->notes_count); ?> notes)</option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 bg-gray-50 rounded-lg p-4">
                        <div class="space-y-4">
                            <?php if($note->is_draft): ?>
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                                    <p class="text-sm text-blue-800">
                                        <strong><?php echo e(__('This note is currently a draft.')); ?></strong>
                                    </p>
                                </div>
                            <?php endif; ?>
                            
                            <?php if($note->scheduled_at && $note->scheduled_at->isFuture()): ?>
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
                                    <p class="text-sm text-yellow-800">
                                        <strong><?php echo e(__('Scheduled for')); ?>:</strong> <?php echo e($note->scheduled_at->format('F d, Y H:i')); ?>
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" name="save_as_draft" id="save_as_draft" value="1" <?php echo e($note->is_draft ? 'checked' : ''); ?>
                            ...
                            <!-- Schedule Publishing -->
                            <div id="schedule-section" class="<?php echo e($note->scheduled_at ? '' : 'hidden'); ?>">
                                <label for="scheduled_at" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('Schedule Publishing')); ?>

                                </label>
                                <input type="datetime-local" name="scheduled_at" id="scheduled_at"
                                    value="<?php echo e($note->scheduled_at ? $note->scheduled_at->format('Y-m-d\TH:i') : ''); ?>"
                                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <p class="mt-1 text-xs text-gray-500">
                                    <?php echo e(__('The note will be published automatically at the scheduled time.')); ?>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                        <a href="<?php echo e(route('notes.index')); ?>" class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-all duration-200">
                            Cancel
                        </a>
                        <button type="submit" id="submit-btn"
                            ...
                            <span id="submit-text"><?php echo e(__('Update Note')); ?></span>
                        </button>
                    </div>
                </div>
            </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (draftCheckbox) {
        draftCheckbox.addEventListener('change', function() {
            if (this.checked) {
                ...
                submitText.textContent = '<?php echo e(__('Save as Draft')); ?>';
                if (publishNowCheckbox) publishNowCheckbox.checked = false;
            } else {
                if (!scheduledAtInput.value) {
                    scheduleSection.classList.add('hidden');
                }
                submitText.textContent = '<?php echo e(__('Update Note')); ?>';
            }
        });
        ...
        if (publishNowCheckbox) {
            publishNowCheckbox.addEventListener('change', function() {
                if (this.checked) {
                    ...
                    scheduleSection.classList.add('hidden');
                    submitText.textContent = '<?php echo e(__('Publish Now')); ?>';
                } else {
                    submitText.textContent = '<?php echo e(__('Update Note')); ?>';
                }
            });
        ...
        if (scheduledAtInput) {
            scheduledAtInput.addEventListener('change', function() {
                if (this.value) {
                    submitText.textContent = '<?php echo e(__('Schedule Note')); ?>';
                    draftCheckbox.checked = false;
                    if (publishNowCheckbox) publishNowCheckbox.checked = false;
    ...
    window.removeExistingThumbnail = function(thumbnail) {
        ...
        const existingThumbnails = <?php echo json_encode($note->thumbnails ?? [], 15, 512) ?>;
...
const priceGuidanceData = <?php echo json_encode($priceGuidance, 15, 512) ?>;
                ...
                if (e.lengthComputable) {
                    ...
                    updateFileItemStatus(fileIndex, 'uploading', percentComplete);
                            ...
                            return new Promise((resolve, reject) => {
                                ...
                                xhr.open('POST', '<?php echo e(route("notes.upload-background")); ?>');
