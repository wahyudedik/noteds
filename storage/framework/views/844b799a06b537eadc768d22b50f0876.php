            ...
            <div class="flex items-center justify-center min-h-screen px-4">
                ...
                <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
                    <h2 class="text-lg font-semibold text-gray-900 mb-4">
                        <?php echo e(__('messages.are_you_sure_delete_account')); ?>

                    </h2>

                    <p class="text-sm text-gray-600 mb-6">
                        <?php echo e(__('messages.delete_account_confirmation')); ?>
                    ...
                    <form method="post" action="<?php echo e(route('profile.destroy')); ?>" class="space-y-4">
                        ...
                        <div>
                            <label for="password" class="sr-only"><?php echo e(__('messages.password')); ?></label>
                            <input type="password" name="password" id="password" required
                                :placeholder="__('messages.enter_your_password')"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['password', 'userDeletion'];
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\profile\partials\delete-user-form.blade.php ENDPATH**/ ?>