<?php $__env->startSection('title', __('messages.note_moderation')); ?>
...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.note_moderation')); ?></h1>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6 mb-8">
            <form method="GET" action="<?php echo e(route('admin.notes.moderation.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Search</label>
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Search title or owner..."
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <option value="sold" <?php echo e($status === 'sold' ? 'selected' : ''); ?>>Sold</option>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <?php if($search || $status || $reportStatus): ?>
                        <a href="<?php echo e(route('admin.notes.moderation.index')); ?>" class="inline-flex items-center justify-center px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 text-sm font-medium rounded-lg">
                            Clear
                        </a>
                    <?php endif; ?>
                </div>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $notes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 text-sm text-gray-900 max-w-md">
                                    <p class="font-medium text-gray-900"><?php echo e(\Illuminate\Support\Str::limit($note->title, 120)); ?></p>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($note->user->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e('@' . $note->user->username); ?></div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e($note->pending_reports_count > 0 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                                            <?php echo e($note->pending_reports_count); ?> pending
                                        </span>
                                        <span class="text-xs text-gray-500">Total: <?php echo e($note->reports_count); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="<?php echo e(route('admin.notes.moderation.show', $note)); ?>" class="inline-flex items-center px-3 py-1.5 text-sm text-blue-600 hover:text-blue-800">
                                        View
                                    </a>
                                </td>
                            </tr>
