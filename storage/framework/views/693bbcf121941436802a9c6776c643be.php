            ...
            <div x-data="settingsTabs()" class="mb-8">
                ...
                <div class="bg-white border-b border-gray-200 rounded-t-lg sticky top-0 z-10 shadow-sm">
                    <div class="flex overflow-x-auto">
                        <button
                            @click="activeTab = 'studio'; localStorage.setItem('settingsActiveTab', 'studio')"
                            :class="activeTab === 'studio' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:text-gray-900'"
                        ...
                        <button
                            @click="activeTab = 'finance'; localStorage.setItem('settingsActiveTab', 'finance')"
                            :class="activeTab === 'finance' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:text-gray-900'"
                            class="px-6 py-4 font-medium text-sm transition-colors flex items-center gap-2 whitespace-nowrap border-b-2 border-transparent"
                            role="tab"
                        ...
                        <button
                            ...
                            :class="activeTab === 'integrations' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:text-gray-900'"
                            class="px-6 py-4 font-medium text-sm transition-colors flex items-center gap-2 whitespace-nowrap border-b-2 border-transparent"
                            role="tab"
                ...
                <!-- Tab Content: Studio -->
                <div x-show="activeTab === 'studio'" x-transition:enter="transition ease-in duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="bg-white rounded-b-lg shadow-sm p-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 mb-6">
                ...
                <!-- Tab Content: Finance -->
                <div x-show="activeTab === 'finance'" x-transition:enter="transition ease-in duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="bg-white rounded-b-lg shadow-sm p-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 mb-6">
                ...
                <div x-show="activeTab === 'integrations'" x-transition:enter="transition ease-in duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="bg-white rounded-b-lg shadow-sm p-6">
