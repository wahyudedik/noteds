<?php $__env->startSection('title', __('messages.ask_your_notes_title')); ?>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.ask_your_notes')); ?></h1>
            </div>
            <p class="text-gray-600"><?php echo e(__('messages.ask_natural_language_questions_description')); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
            <form id="ask-form" class="space-y-4">
                ...
                <div>
                    <label for="question" class="block text-sm font-medium text-gray-700 mb-2">
                        <?php echo e(__('messages.your_question')); ?>
            ...
            <div id="loading" class="hidden mt-6 text-center py-8">
                ...
                <p class="text-gray-600"><?php echo e(__('messages.ai_is_thinking')); ?></p>
            </div>
                ...
                <div class="bg-purple-50 border-l-4 border-purple-500 rounded-r-lg p-6">
                    ...
                    <div id="referenced-notes" class="hidden mt-4 pt-4 border-t border-purple-200">
                        <h4 class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                            ...
                            <?php echo e(__('messages.referenced_notes')); ?>
            ...
            <div id="error-section" class="hidden mt-6">
                <div class="bg-red-50 border-l-4 border-red-500 rounded-r-lg p-6">
                    <h3 class="text-lg font-semibold text-red-900 mb-2"><?php echo e(__('messages.error')); ?></h3>
        ...
        <div class="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-6 mt-6">
            <div class="flex items-start">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-blue-900 mb-2"><?php echo e(__('messages.tips_for_better_answers')); ?></h3>
                    <ul class="text-blue-800 text-sm space-y-1 list-disc list-inside">
                        <li><?php echo e(__('messages.ask_specific_questions')); ?></li>
                        <li><?php echo e(__('messages.mention_names_dates_topics')); ?></li>
                        <li><?php echo e(__('messages.example_question')); ?></li>
                        <li><?php echo e(__('messages.ai_searches_last_100_notes')); ?></li>
                    </ul>
                </div>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("ai-memory.ask")); ?>', {
                method: 'POST',
                headers: {
            ...
            if (data.success) {
                ...
                errorMessage.textContent = data.message || '<?php echo e(__('messages.an_error_occurred')); ?>';
                errorSection.classList.remove('hidden');
            }
        } catch (error) {
            loading.classList.add('hidden');
            askButton.disabled = false;
            errorMessage.textContent = '<?php echo e(__('messages.network_error')); ?>';
            errorSection.classList.remove('hidden');
        }
    });
});
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\mynoteds\ask.blade.php ENDPATH**/ ?>