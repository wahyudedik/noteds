<?php $__env->startSection('title', __('messages.semantic_search_title')); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center gap-3 mb-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.semantic_search')); ?></h1>
            </div>
            <p class="text-gray-600"><?php echo e(__('messages.search_by_meaning_description')); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
            <div class="flex gap-4 mb-4">
                ...
                >
                    <span class="flex items-center gap-2">
                        ...
                        <?php echo e(__('messages.ai_search')); ?>
                ...
                >
                    <span class="flex items-center gap-2">
                        ...
                        <?php echo e(__('messages.basic_search')); ?>
            ...
            <div id="search-loading" class="hidden text-center py-4">
                ...
                <p class="text-sm text-gray-600 mt-2"><?php echo e(__('messages.ai_is_searching')); ?></p>
            </div>
        </div>

        <!-- Basic Search Results -->
        <?php if($query && $results->count() > 0): ?>
            <div id="basic-results" class="bg-white rounded-lg border border-gray-200 shadow-sm mb-6">
                <div class="p-6 border-b border-gray-200">
                    <h2 class="text-xl font-bold text-gray-900">
                        <?php echo e(__('messages.found_results', ['total' => $results->total(), 'query' => $query])); ?>

                    </h2>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border border-gray-200 rounded-lg p-6 hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <?php if($note->summary): ?>
                                    <p class="text-gray-600 mb-3"><?php echo e($note->summary); ?></p>
                                <?php endif; ?>
        ...
        <?php if(!$query): ?>
            <div class="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-6">
                <div class="flex items-start">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-blue-900 mb-2"><?php echo e(__('messages.two_search_modes')); ?></h3>
                        <ul class="text-blue-800 text-sm space-y-2">
                            <li><strong><?php echo e(__('messages.ai_search')); ?>:</strong> <?php echo e(__('messages.ai_search_semantic')); ?></li>
                            <li><strong><?php echo e(__('messages.basic_search')); ?>:</strong> <?php echo e(__('messages.basic_search_traditional')); ?></li>
                        </ul>
                        <p class="text-blue-700 text-sm mt-3">
                            <?php echo e(__('messages.try_searching_natural_language')); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    basicBtn.addEventListener('click', function() {
        ...
        window.location.href = `<?php echo e(route('mynoteds.search')); ?>?q=${encodeURIComponent(query)}`;
    });
    ...
    semanticBtn.addEventListener('click', async function() {
        ...
        try {
            const response = await fetch('<?php echo e(route("ai-memory.search")); ?>', {
                method: 'POST',
                headers: {
            ...
            if (data.success && data.results && data.results.length > 0) {
                const foundResultsText = `<?php echo e(__('messages.found_results_semantic', ['total' => ':total', 'query' => ':query'])); ?>`
                ...
                semanticResults.innerHTML = `
                    <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-12 text-center">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 mb-2"><?php echo e(__('messages.no_results_found')); ?></h3>
                        <p class="text-gray-600">${data.message || '<?php echo e(__('messages.try_different_search_terms')); ?>'}</p>
                    </div>
                `;
                semanticResults.classList.remove('hidden');
            }
            ...
            semanticResults.innerHTML = `
                <div class="bg-red-50 border-l-4 border-red-500 rounded-r-lg p-6">
                    <p class="text-red-800"><?php echo e(__('messages.error')); ?>: ${error.message || '<?php echo e(__('messages.network_error')); ?>'}</p>
                </div>
            `;
            semanticResults.classList.remove('hidden');
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\mynoteds\search.blade.php ENDPATH**/ ?>