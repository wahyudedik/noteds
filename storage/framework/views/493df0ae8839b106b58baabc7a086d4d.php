<?php $__env->startSection('title', __('messages.create_folder')); ?>
...
<div class="py-8 sm:py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <?php if($workspace): ?>
                <a href="<?php echo e(route('workspaces.show', ['workspace' => $workspace->id, 'folder' => $parentFolder?->id])); ?>" class="text-gray-500 hover:text-gray-700 inline-flex items-center mb-4">
                    <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                    <?php echo e(__('messages.back_to_workspace')); ?>
            ...
            <?php endif; ?>
            <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.create_new_folder')); ?></h1>
            <?php if($workspace): ?>
                <p class="text-gray-600 mt-2"><?php echo e(__('messages.creating_folder_in_workspace')); ?>: <strong><?php echo e($workspace->name); ?></strong></p>
            <?php endif; ?>
            <?php if($parentFolder): ?>
                <p class="text-gray-600 mt-1"><?php echo e(__('messages.creating_folder_in')); ?>: <strong><?php echo e($parentFolder->name); ?></strong></p>
            <?php endif; ?>
        </div>

        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            <form action="<?php echo e(route('folders.store')); ?>" method="POST" class="p-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="parent_id" id="parent_id"
                            ...
                            <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($parent->id); ?>" <?php echo e(old('parent_id', $parentFolder?->id) == $parent->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <input type="text" name="color_text" id="color_text" value="<?php echo e(old('color', '#3B82F6')); ?>"
                                pattern="^#[0-9A-Fa-f]{6}$"
                                placeholder="#3B82F6"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-4 border-t border-gray-200">
                        <?php if($workspace): ?>
                            <a href="<?php echo e(route('workspaces.show', ['workspace' => $workspace->id, 'folder' => $parentFolder?->id])); ?>" class="px-4 py-2 text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
                        ...
                        <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
                            <?php echo e(__('messages.create_folder_button')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\folders\create.blade.php ENDPATH**/ ?>