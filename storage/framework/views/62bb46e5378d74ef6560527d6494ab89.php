<?php $__env->startSection('title', __('messages.marketing_simulators')); ?>
...
<div class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-4"><?php echo e(__('messages.marketing_simulators')); ?></h1>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                <?php echo e(__('messages.calculate_potential_earnings')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.earnings_calculator')); ?></h3>
                            <p class="text-blue-100 text-sm"><?php echo e(__('messages.calculate_seller_earnings')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <form id="earnings-form" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.note_price')); ?></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.sales_per_month')); ?></label>
                        ...
                        <button type="button" id="earnings-calculate" 
                            ...
                            <?php echo e(__('messages.calculate_earnings')); ?>
                    ...
                    <div id="earnings-result" class="mt-6 hidden">
                        <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-lg font-bold text-green-800 mb-2"><?php echo e(__('messages.your_potential_earnings')); ?></h4>
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-gray-700"><?php echo e(__('messages.monthly')); ?>:</span>
                                            <span class="font-bold text-green-700" id="earnings-monthly"></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-700"><?php echo e(__('messages.yearly')); ?>:</span>
                                            <span class="font-bold text-green-700" id="earnings-yearly"></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-700"><?php echo e(__('messages.after_commission')); ?>:</span>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.referral_roi')); ?></h3>
                            <p class="text-purple-100 text-sm"><?php echo e(__('messages.track_referral_earnings')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <form id="referral-form" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.total_referrals')); ?></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.avg_transaction')); ?></label>
                        ...
                        <button type="button" id="referral-calculate" 
                            ...
                            <?php echo e(__('messages.calculate_referral_roi')); ?>
                    ...
                    <div id="referral-result" class="mt-6 hidden">
                        <div class="bg-purple-50 border-l-4 border-purple-500 p-4 rounded-r-lg">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    <h4 class="text-lg font-bold text-purple-800 mb-2"><?php echo e(__('messages.your_referral_rewards')); ?></h4>
                                    <div class="space-y-2">
                                        <div class="flex justify-between">
                                            <span class="text-gray-700"><?php echo e(__('messages.signup_rewards')); ?>:</span>
                                            <span class="font-bold text-purple-700" id="referral-signup"></span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-700"><?php echo e(__('messages.transaction_commissions')); ?>:</span>
                                        ...
                                        <div class="flex justify-between border-t-2 border-purple-200 pt-2">
                                            <span class="text-gray-700"><?php echo e(__('messages.total_monthly')); ?>:</span>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-green-500 to-green-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.plan_comparison')); ?></h3>
                            <p class="text-green-100 text-sm"><?php echo e(__('messages.compare_features')); ?></p>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="border-2 border-gray-200 rounded-lg p-4">
                            <div class="flex items-center justify-between mb-3">
                                <h4 class="text-lg font-bold text-gray-900"><?php echo e(__('messages.basic_plan')); ?></h4>
                                <span class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium"><?php echo e(__('messages.free')); ?></span>
                            </div>
                            <div class="space-y-2 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-600">10 <?php echo e(__('messages.notes_total')); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span class="text-sm text-gray-600"><?php echo e(__('messages.standard_support')); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span class="text-sm text-gray-600"><?php echo e(__('messages.public_marketplace')); ?></span>
                                </div>
                            </div>
                            <a href="<?php echo e(route('register')); ?>" class="block w-full bg-gray-600 hover:bg-gray-700 text-white text-center font-semibold py-2 rounded-lg transition-all duration-200">
                        ...
                        <div class="border-2 border-green-500 rounded-lg p-4 bg-gradient-to-br from-green-50 to-transparent relative">
                            <div class="absolute top-0 right-0 bg-green-500 text-white px-3 py-1 rounded-bl-lg rounded-tr-lg text-xs font-bold">
                                <?php echo e(__('messages.best_value')); ?>

                            </div>
                            <div class="flex items-center justify-between mb-3 mt-2">
                                <h4 class="text-lg font-bold text-gray-900"><?php echo e(__('messages.premium_plan')); ?></h4>
                                <span class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium"><?php echo e(\App\Models\Setting::formatPremiumPrice(true)); ?></span>
                            </div>
                            <div class="space-y-2 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-gray-700 font-medium"><?php echo e(__('messages.unlimited_notes')); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span class="text-sm text-gray-700 font-medium"><?php echo e(__('messages.priority_support')); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span class="text-sm text-gray-700 font-medium"><?php echo e(__('messages.featured_in_marketplace')); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span class="text-sm text-gray-700 font-medium"><?php echo e(__('messages.advanced_analytics')); ?></span>
                                </div>
                            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.wallet_simulator')); ?></h3>
                            <p class="text-indigo-100 text-sm"><?php echo e(__('messages.track_balance_transactions')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <div class="bg-indigo-50 rounded-lg p-4 text-center">
                            <p class="text-sm text-gray-600 mb-1"><?php echo e(__('messages.current_balance')); ?></p>
                            <p class="text-3xl font-bold text-indigo-700" id="wallet-balance"><?php echo e(currency(0)); ?></p>
                        </div>
                    </div>
                    <form id="wallet-form" class="space-y-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.topup_amount')); ?></label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.withdraw_amount')); ?></label>
                    ...
                    <div id="wallet-history" class="mt-6 space-y-2 max-h-40 overflow-y-auto">
                        <p class="text-xs text-gray-500 text-center"><?php echo e(__('messages.transaction_history_will_appear')); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-pink-500 to-pink-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.marketplace_preview')); ?></h3>
                            <p class="text-pink-100 text-sm"><?php echo e(__('messages.explore_marketplace_features')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors cursor-pointer" onclick="window.location.href='<?php echo e(route('marketplace.index')); ?>'">
                            <div class="flex items-start justify-between mb-2">
                                <h4 class="font-semibold text-gray-900"><?php echo e(__('messages.sample_note_title')); ?></h4>
                                <span class="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium"><?php echo e(__('messages.free')); ?></span>
                            </div>
                            <p class="text-sm text-gray-600 mb-2"><?php echo e(__('messages.preview_marketplace_notes')); ?></p>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span class="text-xs text-gray-500"><?php echo e(__('messages.reviews_with_count', ['count' => 15])); ?></span>
                                </div>
                                <span class="text-sm font-semibold text-gray-900"><?php echo e(currency(0)); ?></span>
                            </div>
                        </div>
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                            <p class="text-xs text-blue-800">
                                <strong><?php echo e(__('messages.marketplace_features')); ?></strong> <?php echo e(__('messages.marketplace_features_desc')); ?>

                            </p>
                        </div>
                        <a href="<?php echo e(route('marketplace.index')); ?>" class="block w-full bg-pink-600 hover:bg-pink-700 text-white text-center font-semibold py-2 rounded-lg transition-all duration-200">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.transaction_flow')); ?></h3>
                            <p class="text-orange-100 text-sm"><?php echo e(__('messages.visualize_payment_process')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <div class="space-y-4" id="transaction-flow">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-900"><?php echo e(__('messages.select_note')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(__('messages.choose_note_to_purchase')); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3 opacity-50" id="flow-step-2">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-700"><?php echo e(__('messages.checkout')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(__('messages.review_order_details')); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3 opacity-50" id="flow-step-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-700"><?php echo e(__('messages.payment')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(__('messages.secure_payment_via_midtrans')); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3 opacity-50" id="flow-step-4">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-700"><?php echo e(__('messages.complete')); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e(__('messages.access_granted_to_note')); ?></p>
                            </div>
                        </div>
                    </div>
                    <button type="button" id="flow-simulate" 
                        ...
                        <?php echo e(__('messages.simulate_transaction')); ?>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="bg-gradient-to-r from-violet-500 to-violet-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2"><?php echo e(__('messages.price_benchmark')); ?></h3>
                            <p class="text-violet-100 text-sm"><?php echo e(__('messages.compare_note_prices')); ?></p>
                        </div>
                ...
                <div class="p-6">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.your_note_price')); ?></label>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2"><?php echo e(__('messages.category')); ?></label>
                        <select id="benchmark-category" 
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-violet-500 focus:ring-2 focus:ring-violet-500">
                            <option value=""><?php echo e(__('messages.all_categories')); ?></option>
                            <option value="tutorial"><?php echo e(__('messages.tutorial')); ?></option>
                            <option value="template"><?php echo e(__('messages.template')); ?></option>
                            <option value="guide"><?php echo e(__('messages.guide')); ?></option>
                            <option value="resource"><?php echo e(__('messages.resource')); ?></option>
                        </select>
                    </div>
                    <button type="button" id="benchmark-calculate" 
                        ...
                        <?php echo e(__('messages.compare_note_prices')); ?>

                    </button>
                    <div id="benchmark-result" class="mt-6 hidden">
                        <div class="bg-violet-50 border-l-4 border-violet-500 p-4 rounded-r-lg">
                            <h4 class="text-lg font-bold text-violet-800 mb-3"><?php echo e(__('messages.market_analysis')); ?></h4>
                            <div class="space-y-2">
                                <div class="flex justify-between">
                                    <span class="text-gray-700"><?php echo e(__('messages.market_average')); ?></span>
                                    <span class="font-bold text-gray-900" id="benchmark-avg"></span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-700"><?php echo e(__('messages.your_price')); ?></span>
                                ...
                                <div class="flex justify-between border-t-2 border-violet-200 pt-2">
                                    <span class="text-gray-700"><?php echo e(__('messages.position')); ?></span>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white">
            <h2 class="text-3xl font-bold mb-4"><?php echo e(__('messages.simulator_ready_to_start')); ?></h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        simulateTransaction: <?php echo json_encode(__('messages.simulate_transaction'), 15, 512) ?>,
        transactionComplete: <?php echo json_encode(__('messages.transaction_complete'), 15, 512) ?>,
        processing: <?php echo json_encode(__('messages.processing'), 15, 512) ?>,
        generating: <?php echo json_encode(__('messages.generating'), 15, 512) ?>,
        insufficientBalance: <?php echo json_encode(__('messages.insufficient_balance'), 15, 512) ?>,
        topup: <?php echo json_encode(__('messages.topup'), 15, 512) ?>,
        withdraw: <?php echo json_encode(__('messages.withdraw'), 15, 512) ?>,
        marketAnalysis: <?php echo json_encode(__('messages.market_analysis'), 15, 512) ?>,
        marketAverageLabel: <?php echo json_encode(__('messages.market_average'), 15, 512) ?>,
        yourPrice: <?php echo json_encode(__('messages.your_price'), 15, 512) ?>,
        position: <?php echo json_encode(__('messages.position'), 15, 512) ?>,
        belowMarket: <?php echo json_encode(__('messages.below_market'), 15, 512) ?>,
        aboveMarket: <?php echo json_encode(__('messages.above_market'), 15, 512) ?>,
        marketAverageCompetitive: <?php echo json_encode(__('messages.market_average_competitive'), 15, 512) ?>,
    };
    
    const currencySettings = {
        locale: <?php echo json_encode($simulatorLocale, 15, 512) ?>,
        currency: <?php echo json_encode($simulatorCurrency, 15, 512) ?>,
    };
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\simulators\index.blade.php ENDPATH**/ ?>