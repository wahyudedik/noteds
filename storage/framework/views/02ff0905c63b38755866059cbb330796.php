<?php $__env->startSection('title', __('messages.edit_tutorial')); ?>

<?php $__env->startSection('content'); ?>
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900"><?php echo e(__('messages.edit_tutorial')); ?></h2>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            <form action="<?php echo e(route('admin.tutorials.update', $tutorial)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                        id="title"
                        name="title"
                        value="<?php echo e(old('title', $tutorial->title)); ?>"
                        required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" 
                        id="slug"
                        name="slug"
                        value="<?php echo e(old('slug', $tutorial->slug)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $tutorial->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="hidden" id="content" name="content" value="<?php echo e(old('content', $tutorial->content)); ?>" required>
...
unset($__errorArgs, $__bag); ?>">
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('category', $tutorial->category) === $key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <?php if($tutorial->thumbnail): ?>
                        <div class="mb-2">
                            <img src="<?php echo e(Storage::url($tutorial->thumbnail)); ?>" alt="Current thumbnail" class="h-32 w-auto rounded border border-gray-300">
                        </div>
                    <?php endif; ?>
                    <input type="file" 
                        id="thumbnail"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="url" 
                        id="video_url"
                        name="video_url"
                        value="<?php echo e(old('video_url', $tutorial->video_url)); ?>"
...
unset($__errorArgs, $__bag); ?>">
                        <option value="draft" <?php echo e(old('status', $tutorial->status) === 'draft' ? 'selected' : ''); ?>>Draft</option>
                        <option value="published" <?php echo e(old('status', $tutorial->status) === 'published' ? 'selected' : ''); ?>>Published</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" 
                            name="featured" 
                            value="1"
                            <?php echo e(old('featured', $tutorial->featured) ? 'checked' : ''); ?>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" 
                        id="order"
                        name="order"
                        value="<?php echo e(old('order', $tutorial->order)); ?>"
                        min="0"
                        placeholder="0"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\tutorials\edit.blade.php ENDPATH**/ ?>