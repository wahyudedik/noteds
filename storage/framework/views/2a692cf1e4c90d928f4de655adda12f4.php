    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.notifications')); ?></h1>
                    <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.all_notifications_one_place')); ?></p>
                </div>
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('notifications.preferences.index')); ?>"
                ...
                <?php if(auth()->user()->notifications()->unread()->count() > 0): ?>
                    <form action="<?php echo e(route('notifications.mark-all-read')); ?>" method="POST" class="inline-block">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-sm hover:shadow-md transition-all duration-200">
                            <?php echo e(__('messages.mark_all_read')); ?>
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <a href="<?php echo e($notification->link ?? '#'); ?>" class="block bg-white shadow-sm rounded-lg border <?php echo e(!$notification->is_read ? 'border-blue-300 bg-blue-50' : 'border-gray-200'); ?> hover:shadow-md transition-all duration-200">
                    <div class="p-6">
                        <div class="flex items-start gap-4">
                            <!-- Icon -->
                            <div class="flex-shrink-0">
                                <?php if($notification->type === 'purchase'): ?>
                                ...
                                <?php elseif($notification->type === 'ticket_response'): ?>
                                ...
                                <?php elseif($notification->type === 'ticket_new'): ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-base font-semibold text-gray-900 mb-1"><?php echo e($notification->title); ?></h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views/notifications/index.blade.php ENDPATH**/ ?>