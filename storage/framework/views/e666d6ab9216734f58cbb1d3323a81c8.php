<?php $__env->startSection('title', __('messages.batch_download')); ?>
...
<div class="py-8 sm:py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <?php if($purchasedNotes->count() > 0): ?>
            <form id="batchDownloadForm" action="<?php echo e(route('batch-download.download')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                                ...
                                <label class="flex items-start cursor-pointer">
                                    ...
                                    <div class="ml-3 flex-1">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1">
                                                <h3 class="text-sm font-semibold text-gray-900"><?php echo e($note->title); ?></h3>
                                                <p class="text-xs text-gray-500 mt-1">
                                                    by <?php echo e($note->user->name); ?>
                                                ...
                                                <div class="mt-2 flex items-center gap-4 text-xs text-gray-600">
                                                    <span class="flex items-center">
                                                        ...
                                                        <?php echo e(count($note->attachments ?? [])); ?> file(s)
                                                    </span>
                                                    <?php if($note->price > 0): ?>
                                                        <span class="flex items-center">
                                                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <?php if(!empty($note->attachments)): ?>
                                                    <div class="mt-2 space-y-1">
                                                        <?php $__currentLoopData = array_slice($note->attachments, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php
                                                            ...
                                                            <p class="text-xs text-gray-500 flex items-center">
                                                                ...
                                                                <?php echo e(Str::limit($filename, 40)); ?>

                                                            </p>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(count($note->attachments) > 3): ?>
                                                            <p class="text-xs text-gray-400 italic">
                                                                +<?php echo e(count($note->attachments) - 3); ?> more file(s)
                                                            </p>
                                                        <?php endif; ?>
                                                    </div>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\buyer\batch-download\index.blade.php ENDPATH**/ ?>