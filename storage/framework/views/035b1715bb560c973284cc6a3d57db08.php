...
<div x-data="{
    ...
    <aside
        ...
        <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
            <a href="/" class="flex items-center gap-2 min-w-0">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="<?php echo e(config('app.name', 'Noteds')); ?>" class="h-8 w-8 flex-shrink-0">
                ...
                <div class="space-y-1">
                    <?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e($item['href']); ?>"
                            ...
                            <span class="flex-shrink-0 <?php echo $item['active']
                ...
                <div class="flex items-center gap-3">
                    <div
                        ...
                        <span class="text-sm font-semibold text-white"
                            style="display: <?php echo e(auth()->user()->avatar ? 'none' : 'flex'); ?>;">
    ...
    <aside x-show="sidebarOpen" x-transition:enter="transition ease-in-out duration-300 transform"
        ...
        <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
            <a href="/" class="flex items-center gap-2 min-w-0">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="<?php echo e(config('app.name', 'Noteds')); ?>"
                ...
                <div class="space-y-1">
                    <?php $__currentLoopData = $group['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($item['submenu']) && count($item['submenu']) > 0): ?>
                            <div x-data="{ open: <?php echo e($item['active'] ? 'true' : 'false'); ?> }" class="space-y-1">
                                <button @click="open = !open"
                                    class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md <?php echo e($item['active'] ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-colors duration-150">
                                    <div class="flex items-center gap-3 min-w-0">
                                        <span class="flex-shrink-0"><?php echo $item['icon']; ?></span>
                                ...
                                <div x-show="open" class="pl-3 space-y-1">
                                    <?php $__currentLoopData = $item['submenu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e($subitem['href']); ?>"
                                            class="block px-3 py-2 text-sm rounded-md <?php echo e($subitem['active'] ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-colors duration-150">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($item['href']); ?>"
                                class="flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md <?php echo e($item['active'] ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?> transition-colors duration-150">
                                <span class="flex-shrink-0"><?php echo $item['icon']; ?></span>
                                <span class="truncate"><?php echo e($item['label']); ?></span>
                            </a>
                        <?php endif; ?>
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views/components/sidebar.blade.php ENDPATH**/ ?>