<?php $__env->startSection('title', 'Create Contest'); ?>
...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <div class="p-6">
                <form action="<?php echo e(route('admin.contests.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="type" id="type" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <option value="monthly" <?php echo e(old('type') === 'monthly' ? 'selected' : ''); ?>>Monthly Challenge</option>
                                    <option value="themed" <?php echo e(old('type') === 'themed' ? 'selected' : ''); ?>>Themed Contest</option>
                                    <option value="custom" <?php echo e(old('type') === 'custom' ? 'selected' : ''); ?>>Custom Contest</option>
                                </select>
                            </div>
                            ...
                            <div id="theme-field" style="display: none;">
                                ...
                                <input type="text" name="theme" id="theme" value="<?php echo e(old('theme')); ?>"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="voting" <?php echo e(old('status') === 'voting' ? 'selected' : ''); ?>>Voting</option>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="datetime-local" name="voting_start_date" id="voting_start_date" value="<?php echo e(old('voting_start_date')); ?>"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="voting_end_date" id="voting_end_date" value="<?php echo e(old('voting_end_date')); ?>"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_entries_per_user" id="max_entries_per_user" value="<?php echo e(old('max_entries_per_user', 1)); ?>" min="1" required
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="prizes_json" id="prizes_json" rows="6"
                                ...
                                placeholder='[{"position": 1, "type": "cash", "value": 100}, {"position": 2, "type": "badge", "badge_id": "..."}]'><?php echo e(old('prizes_json')); ?></textarea>
                        ...
                        <div>
                            ...
                            <textarea name="rules_text" id="rules_text" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Rule 1&#10;Rule 2&#10;Rule 3"><?php echo e(old('rules_text')); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\contests\create.blade.php ENDPATH**/ ?>