<?php $__env->startSection('title', __('messages.my_notes')); ?>
...
<div class="py-8 sm:py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.notes')); ?></h1>
                <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.manage_notes', [], app()->getLocale()) ?: 'Manage and organize all your notes'); ?></p>
            </div>
            <a href="<?php echo e(route('notes.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                ...
                <?php echo e(__('messages.create')); ?> <?php echo e(__('messages.notes')); ?>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-4">
                                <h3 class="text-lg font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-blue-600 transition-colors duration-200">
                                    <a href="<?php echo e(route('notes.show', $note)); ?>"><?php echo e($note->title); ?></a>
                                </h3>
                            ...
                            <?php if($note->tags->count() > 0): ?>
                                <div class="flex flex-wrap gap-2 mb-4">
                                    ...
                                    <?php if($note->tags->count() > 3): ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600">
                                            +<?php echo e($note->tags->count() - 3); ?> <?php echo e(__('messages.more')); ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mb-4">
                                ...
                                <?php if($note->hasAttachments()): ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-800" title="<?php echo e($note->file_count); ?> <?php echo e($note->file_count == 1 ? __('messages.file') : __('messages.files')); ?>">
                                        <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                        </svg>
                                        <?php echo e($note->file_count); ?>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                                ...
                                <div class="flex items-center gap-3">
                                    <a href="<?php echo e(route('notes.show', $note)); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors duration-200">
                                        <?php echo e(__('messages.view')); ?>

                                    </a>
                                    <a href="<?php echo e(route('notes.edit', $note)); ?>" class="text-sm font-medium text-green-600 hover:text-green-700 transition-colors duration-200">
                                        <?php echo e(__('messages.edit')); ?>

                                    </a>
                                    <form action="<?php echo e(route('notes.destroy', $note)); ?>" method="POST" class="inline delete-note-form">
                                        <?php echo csrf_field(); ?>
