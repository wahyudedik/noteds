<?php $__env->startSection('title', __('messages.admin_add_social_media')); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.admin_add_social_media')); ?></h1>
                    <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.add_new_social_link')); ?></p>
                </div>
        ...
        <form action="<?php echo e(route('admin.social-media.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('platform') === $key ? 'selected' : ''); ?>>
                                <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="icon" id="icon" rows="4"
                        ...
                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 font-mono text-sm"><?php echo e(old('icon')); ?></textarea>
                ...
                <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="px-6 py-2 border border-transparent rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200">
                        <?php echo e(__('messages.create_link')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\admin\social-media\create.blade.php ENDPATH**/ ?>