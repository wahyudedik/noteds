<?php $__env->startSection('title', __('messages.forum_index')); ?>
...
<div class="py-10 sm:py-12 bg-slate-50 min-h-screen">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10">
            <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-indigo-500 to-purple-500 text-white shadow-lg">
                ...
                <div class="relative z-10 px-6 py-8 sm:px-8 sm:py-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <a href="<?php echo e(route('forum.preferences.edit')); ?>"
            ...
            <div class="relative z-10 -mt-6 sm:-mt-8">
                <div class="rounded-2xl bg-white px-4 py-4 shadow-lg ring-1 ring-slate-100 sm:px-5">
                    <form action="<?php echo e(route('forum.index')); ?>" method="GET" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            <?php if($search ?? false): ?>
                                <a href="<?php echo e(route('forum.index', ['filter' => $filter])); ?>"
            ...
            <div class="mt-6">
                <div class="flex gap-2 overflow-x-auto pb-1">
                    ...
                    <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('forum.index', ['filter' => $value])); ?>"
                           class="whitespace-nowrap rounded-full px-4 py-2 text-sm font-medium transition <?php echo e($filter === $value ? 'bg-blue-600 text-white shadow-sm' : 'bg-white text-slate-600 shadow ring-1 ring-slate-200 hover:text-slate-900'); ?>">
                            <?php echo e($label); ?>
        ...
        <div class="mb-10 rounded-3xl border border-white/60 bg-white/90 p-6 shadow-xl shadow-blue-50/40 backdrop-blur">
            <form action="<?php echo e(route('forum.store')); ?>" method="POST" id="createPostForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="mb-5">
                ...
                <div id="noteSelection" class="mb-5 hidden">
                    ...
                    <select name="note_id"
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php $__currentLoopData = auth()->user()->notes()->where('status', 'active')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="mb-5 grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="datetime-local"
                               name="scheduled_for"
                               value="<?php echo e(old('scheduled_for')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\forum\index.blade.php ENDPATH**/ ?>