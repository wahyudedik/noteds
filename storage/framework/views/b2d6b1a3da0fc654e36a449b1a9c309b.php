...
<head>
    ...
    <?php
        $disableTextSelection = \App\Models\Setting::getSetting(
    ...
    ?>
    <?php if($disableTextSelection || $disableDragDrop): ?>
        <style>
            <?php if($disableTextSelection): ?>
    ...
    <script>
        ...
        window.__translations = <?php echo json_encode(trans('messages'), 15, 512) ?>;
...
<body
    class="font-sans antialiased bg-gray-50 dark:bg-gray-900 overflow-x-hidden transition-colors duration-200 <?php echo e(request()->routeIs('notes.create') ? 'create-note-page' : ''); ?> <?php echo e(request()->routeIs('notes.edit') ? 'edit-note-page' : ''); ?>">
    <div class="min-h-screen flex h-screen">
        <?php echo $__env->make('components.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <div class="flex-1 flex flex-col overflow-hidden min-w-0 h-full">
            <?php echo $__env->make('components.top-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

            <!-- Page Heading -->
            <?php if(isset($header)): ?>
                <header
                    class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 transition-colors duration-200 flex-shrink-0">
            ...
            <main class="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900 min-w-0">
                <div class="w-full">
                    ...
                    <footer
                        class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 w-full mt-12">
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 leading-relaxed">
                                        <?php echo e(__('messages.about_description')); ?>
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">
                                        <?php echo e(__('messages.quick_links')); ?>
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            <li>
                                                <a href="<?php echo e(route('notes.index')); ?>"
                                                    class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                                    <?php echo e(__('messages.my_notes')); ?>
                                    ...
                                    <ul class="space-y-2">
                                        <li>
                                            <a href="<?php echo e(route('docs.index')); ?>"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                                <?php echo e(__('messages.documentation')); ?>
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('cms.show', ['cmsPage' => 'privacy-policy'])); ?>"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('cms.show', ['cmsPage' => 'terms-and-conditions'])); ?>"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                                <?php echo e(__('messages.terms_and_conditions')); ?>

                                            </a>
                                        </li>
                                        <li>
                                            <a href="mailto:info@noteds.com"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                                info@noteds.com
                                            </a>
                                        </li>
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-4">
                                        ...
                                        ?>
                                        <?php $__empty_1 = true; $__currentLoopData = $socialMediaLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
                                <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                                    &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Noteds')); ?>.
    ...
    <?php if(session('warning')): ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    window.showWarning(<?php echo json_encode(session('warning'), 15, 512) ?>);
                });
            </script>
        <?php $__env->stopPush(); ?>
    <?php endif; ?>
    ...
    <?php if(session('info')): ?>
        <?php $__env->startPush('scripts'); ?>
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    window.showInfo(<?php echo json_encode(session('info'), 15, 512) ?>);
                });
            </script>
        <?php $__env->stopPush(); ?>
    <?php endif; ?>
    ...
    <?php
        $protectionSettings = [
            'disable_right_click' => \App\Models\Setting::getSetting(
                'protection_disable_right_click',
                'content_protection',
                false,
            ),
            'disable_keyboard_shortcuts' => \App\Models\Setting::getSetting(
                'protection_disable_keyboard_shortcuts',
                'content_protection',
                false,
            ),
            'disable_copy_paste' => \App\Models\Setting::getSetting(
                'protection_disable_copy_paste',
                'content_protection',
                false,
            ),
            'disable_drag_drop' => \App\Models\Setting::getSetting(
            ...
            'disable_view_source' => \App\Models\Setting::getSetting(
                'protection_disable_view_source',
                'content_protection',
                false,
            ),
            'detect_devtools' => \App\Models\Setting::getSetting(
                'protection_detect_devtools',
                'content_protection',
                false,
            ),
            'disable_screenshot' => \App\Models\Setting::getSetting(
                'protection_disable_screenshot',
                'content_protection',
                false,
            ),
            'disable_image_saving' => \App\Models\Setting::getSetting(
                'protection_disable_image_saving',
                'content_protection',
                false,
            ),
            'disable_console' => \App\Models\Setting::getSetting(
                'protection_disable_console',
                'content_protection',
                false,
            ),
            'monitor_clipboard' => \App\Models\Setting::getSetting(
                'protection_monitor_clipboard',
                'content_protection',
                false,
            ),
            'disable_print_screen' => \App\Models\Setting::getSetting(
                'protection_disable_print_screen',
                'content_protection',
                false,
            ),
            'disable_snipping_tool' => \App\Models\Setting::getSetting(
                'protection_disable_snipping_tool',
                'content_protection',
                false,
            ),
            'detect_window_blur' => \App\Models\Setting::getSetting(
                'protection_detect_window_blur',
                'content_protection',
                false,
            ),
            'detect_visibility_change' => \App\Models\Setting::getSetting(
                'protection_detect_visibility_change',
                'content_protection',
                false,
            ),
            'clear_clipboard_periodic' => \App\Models\Setting::getSetting(
            ...
            'disable_devtools_shortcuts' => \App\Models\Setting::getSetting(
                'protection_disable_devtools_shortcuts',
                'content_protection',
                false,
            ),
            'detect_ai_bots' => \App\Models\Setting::getSetting(
                'protection_detect_ai_bots',
                'content_protection',
                false,
            ),
            'detect_headless' => \App\Models\Setting::getSetting(
                'protection_detect_headless',
                'content_protection',
                false,
            ),
            'detect_mouse_movement' => \App\Models\Setting::getSetting(
                'protection_detect_mouse_movement',
                'content_protection',
                false,
            ),
            'detect_click_pattern' => \App\Models\Setting::getSetting(
                'protection_detect_click_pattern',
                'content_protection',
                false,
            ),
            'detect_screen_recording' => \App\Models\Setting::getSetting(
    ...
    <script>
        (function() {
            ...
            const protectionSettings = <?php echo json_encode($protectionSettings, 15, 512) ?>;

            <?php if($protectionSettings['blur_overlay']): ?>
                // Blur overlay untuk mencegah screenshot
                const blurOverlay = document.createElement('div');
                blurOverlay.id = 'screenshot-protection-overlay';
                blurOverlay.style.cssText =
                    'position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.9);z-index:9999999;display:none;backdrop-filter:blur(10px);';
                document.body.appendChild(blurOverlay);
            <?php endif; ?>

            <?php if($protectionSettings['disable_right_click']): ?>
            ...
            document.addEventListener('keydown', function(e) {
                <?php if($protectionSettings['disable_print_screen']): ?>
            ...
            if (protectionSettings.detect_ai_bots) {
                ...
                document.addEventListener('mousemove', function(e) {
                    ...
                    if (mouseMovements.length >= 20) {
                        ...
                        const variance = speeds.reduce((sum, speed) => sum + Math.pow(speed - avgSpeed, 2), 0) /
                            speeds.length;
                ...
                document.addEventListener('click', function(e) {
                    ...
                    if (lastClickTime > 0) {
                        ...
                        if (clickTimes.length >= 10) {
                            ...
                            const variance = clickTimes.reduce((sum, time) => sum + Math.pow(time - avgTime, 2),
                                0) / clickTimes.length;
                ...
                window.addEventListener('scroll', function() {
                    ...
                    if (scrollEvents.length >= 15) {
                        ...
                        const variance = times.reduce((sum, time) => sum + Math.pow(time - avgTime, 2), 0) /
                            times.length;
                ...
                setInterval(function() {
                    ...
                    const scrollPercentage = (window.pageYOffset / (document.documentElement.scrollHeight -
                ...
                if (aiDetected || suspiciousMovement) {
                    ...
                    if (typeof blurOverlay !== 'undefined') {
                        ...
                        blurOverlay.innerHTML =
                            '<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);color:white;font-size:24px;font-weight:bold;text-align:center;">AI Tool Detected<br><span style="font-size:16px;">Automated access is not allowed</span></div>';
                    }
                    ...
                    setTimeout(function() {
                        ...
                        document.body.innerHTML =
                            '<div style="display:flex;align-items:center;justify-content:center;height:100vh;font-size:24px;color:red;">AI Tool Detected. Automated access is not allowed on this website.</div>';
                    }, 3000);
    ...
    <div id="pwa-install-banner"
        class="hidden fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl p-4 z-50">
        <div class="flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-600 dark:text-gray-300 mb-3">Install aplikasi untuk akses lebih cepat dan
                    pengalaman yang lebih baik!</p>
                <div class="flex gap-2">
                    <button onclick="installPWA()"
                        class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-xs font-medium px-3 py-2 rounded-md transition-colors">
                        Install
                    </button>
                    <button onclick="document.getElementById('pwa-install-banner').classList.add('hidden')"
                        class="px-3 py-2 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors">
                        Nanti
                    </button>
                </div>
            </div>
    ...
    <?php echo $__env->make('components.featured-popups', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH D:\PROJECT\LARAVEL\noteds\resources\views\layouts\app.blade.php ENDPATH**/ ?>