<?php $__env->startSection('title', __('messages.create_new_note')); ?>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900"><?php echo e(__('messages.create_new_note')); ?></h1>
                </div>
                <p class="mt-2 text-base text-gray-600"><?php echo e(__('messages.share_knowledge')); ?></p>
            </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="title" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.title')); ?> <span class="text-red-500 font-bold" title="Wajib diisi">*</span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="ecosystem_category" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.ecosystem_category')); ?>
                                ...
                                <select name="ecosystem_category" id="ecosystem_category"
                                    ...
                                    <?php $__currentLoopData = $ecosystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('ecosystem_category')===$key ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                ...
                                <div id="code-fields" class="hidden p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="text" name="code_language" id="code_language" value="<?php echo e(old('code_language')); ?>"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="code_framework" id="code_framework" value="<?php echo e(old('code_framework')); ?>"
                                        ...
                                        <div>
                                            ...
                                            <select name="code_type" id="code_type"
                                                ...
                                                <option value="plugin" <?php echo e(old('code_type') === 'plugin' ? 'selected' : ''); ?>>Plugin</option>
                                                <option value="script" <?php echo e(old('code_type') === 'script' ? 'selected' : ''); ?>>Script</option>
                                                <option value="library" <?php echo e(old('code_type') === 'library' ? 'selected' : ''); ?>>Library</option>
                                                <option value="component" <?php echo e(old('code_type') === 'component' ? 'selected' : ''); ?>>Component</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="code_demo_link" id="code_demo_link" value="<?php echo e(old('code_demo_link')); ?>"
                                ...
                                <div id="photo-fields" class="hidden p-4 bg-green-50 border border-green-200 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="text" name="photo_resolution" id="photo_resolution" value="<?php echo e(old('photo_resolution')); ?>"
                                        ...
                                        <div>
                                            ...
                                            <select name="photo_type" id="photo_type"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500">
                                                <option value="">Pilih Tipe</option>
                                                <option value="stock" <?php echo e(old('photo_type') === 'stock' ? 'selected' : ''); ?>>Stock</option>
                                                <option value="portrait" <?php echo e(old('photo_type') === 'portrait' ? 'selected' : ''); ?>>Portrait</option>
                                                <option value="landscape" <?php echo e(old('photo_type') === 'landscape' ? 'selected' : ''); ?>>Landscape</option>
                                                <option value="product" <?php echo e(old('photo_type') === 'product' ? 'selected' : ''); ?>>Product</option>
                                                <option value="event" <?php echo e(old('photo_type') === 'event' ? 'selected' : ''); ?>>Event</option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="photo_format" id="photo_format"
                                                ...
                                                <option value="jpeg" <?php echo e(old('photo_format') === 'jpeg' ? 'selected' : ''); ?>>JPEG</option>
                                                <option value="jpg" <?php echo e(old('photo_format') === 'jpg' ? 'selected' : ''); ?>>JPG</option>
                                                <option value="png" <?php echo e(old('photo_format') === 'png' ? 'selected' : ''); ?>>PNG</option>
                                                <option value="raw" <?php echo e(old('photo_format') === 'raw' ? 'selected' : ''); ?>>RAW</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="photo_gallery_link" id="photo_gallery_link" value="<?php echo e(old('photo_gallery_link')); ?>"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <select name="design_type" id="design_type"
                                                ...
                                                <option value="">Pilih Tipe</option>
                                                <option value="logo" <?php echo e(old('design_type') === 'logo' ? 'selected' : ''); ?>>Logo</option>
                                                <option value="flyer" <?php echo e(old('design_type') === 'flyer' ? 'selected' : ''); ?>>Flyer</option>
                                                <option value="icon" <?php echo e(old('design_type') === 'icon' ? 'selected' : ''); ?>>Icon</option>
                                                <option value="illustration" <?php echo e(old('design_type') === 'illustration' ? 'selected' : ''); ?>>Illustration</option>
                                                <option value="print" <?php echo e(old('design_type') === 'print' ? 'selected' : ''); ?>>Print</option>
                                                <option value="branding" <?php echo e(old('design_type') === 'branding' ? 'selected' : ''); ?>>Branding</option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="design_format" id="design_format"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
                                                <option value="">Pilih Format</option>
                                                <option value="ai" <?php echo e(old('design_format') === 'ai' ? 'selected' : ''); ?>>AI (Illustrator)</option>
                                                <option value="psd" <?php echo e(old('design_format') === 'psd' ? 'selected' : ''); ?>>PSD (Photoshop)</option>
                                                <option value="eps" <?php echo e(old('design_format') === 'eps' ? 'selected' : ''); ?>>EPS</option>
                                                <option value="pdf" <?php echo e(old('design_format') === 'pdf' ? 'selected' : ''); ?>>PDF</option>
                                                <option value="svg" <?php echo e(old('design_format') === 'svg' ? 'selected' : ''); ?>>SVG</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="design_preview_link" id="design_preview_link" value="<?php echo e(old('design_preview_link')); ?>"
                                ...
                                <div id="audio-fields" class="hidden p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="number" name="audio_duration" id="audio_duration" value="<?php echo e(old('audio_duration')); ?>"
                                        ...
                                        <div>
                                            ...
                                            <select name="audio_format" id="audio_format"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500">
                                                <option value="">Pilih Format</option>
                                                <option value="mp3" <?php echo e(old('audio_format') === 'mp3' ? 'selected' : ''); ?>>MP3</option>
                                                <option value="wav" <?php echo e(old('audio_format') === 'wav' ? 'selected' : ''); ?>>WAV</option>
                                                <option value="flac" <?php echo e(old('audio_format') === 'flac' ? 'selected' : ''); ?>>FLAC</option>
                                                <option value="aac" <?php echo e(old('audio_format') === 'aac' ? 'selected' : ''); ?>>AAC</option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <input type="text" name="audio_genre" id="audio_genre" value="<?php echo e(old('audio_genre')); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input type="url" name="audio_link" id="audio_link" value="<?php echo e(old('audio_link')); ?>"
                                ...
                                <div id="video-fields" class="hidden p-4 bg-red-50 border border-red-200 rounded-lg">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="number" name="video_duration" id="video_duration" value="<?php echo e(old('video_duration')); ?>"
                                        ...
                                        <div>
                                            ...
                                            <input type="text" name="video_resolution" id="video_resolution" value="<?php echo e(old('video_resolution')); ?>"
                                                placeholder="1920x1080, 4K, dll"
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500">
                                        </div>
                                        <div>
                                            ...
                                            <select name="video_format" id="video_format"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-red-500 focus:ring-2 focus:ring-red-500">
                                                <option value="">Pilih Format</option>
                                                <option value="mp4" <?php echo e(old('video_format') === 'mp4' ? 'selected' : ''); ?>>MP4</option>
                                                <option value="mov" <?php echo e(old('video_format') === 'mov' ? 'selected' : ''); ?>>MOV</option>
                                                <option value="avi" <?php echo e(old('video_format') === 'avi' ? 'selected' : ''); ?>>AVI</option>
                                                <option value="webm" <?php echo e(old('video_format') === 'webm' ? 'selected' : ''); ?>>WebM</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="video_link" id="video_link" value="<?php echo e(old('video_link')); ?>"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <select name="theme_platform" id="theme_platform"
                                                ...
                                                <option value="wordpress" <?php echo e(old('theme_platform') === 'wordpress' ? 'selected' : ''); ?>>WordPress</option>
                                                <option value="shopify" <?php echo e(old('theme_platform') === 'shopify' ? 'selected' : ''); ?>>Shopify</option>
                                                <option value="html" <?php echo e(old('theme_platform') === 'html' ? 'selected' : ''); ?>>HTML</option>
                                                <option value="drupal" <?php echo e(old('theme_platform') === 'drupal' ? 'selected' : ''); ?>>Drupal</option>
                                                <option value="magento" <?php echo e(old('theme_platform') === 'magento' ? 'selected' : ''); ?>>Magento</option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="theme_type" id="theme_type"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                                                <option value="">Pilih Tipe</option>
                                                <option value="business" <?php echo e(old('theme_type') === 'business' ? 'selected' : ''); ?>>Business</option>
                                                <option value="ecommerce" <?php echo e(old('theme_type') === 'ecommerce' ? 'selected' : ''); ?>>E-commerce</option>
                                                <option value="blog" <?php echo e(old('theme_type') === 'blog' ? 'selected' : ''); ?>>Blog</option>
                                                <option value="portfolio" <?php echo e(old('theme_type') === 'portfolio' ? 'selected' : ''); ?>>Portfolio</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="theme_preview_link" id="theme_preview_link" value="<?php echo e(old('theme_preview_link')); ?>"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <select name="three_d_format" id="three_d_format"
                                                ...
                                                <option value="">Pilih Format</option>
                                                <option value="obj" <?php echo e(old('three_d_format') === 'obj' ? 'selected' : ''); ?>>OBJ</option>
                                                <option value="fbx" <?php echo e(old('three_d_format') === 'fbx' ? 'selected' : ''); ?>>FBX</option>
                                                <option value="blend" <?php echo e(old('three_d_format') === 'blend' ? 'selected' : ''); ?>>Blend</option>
                                                <option value="dae" <?php echo e(old('three_d_format') === 'dae' ? 'selected' : ''); ?>>DAE</option>
                                                <option value="3ds" <?php echo e(old('three_d_format') === '3ds' ? 'selected' : ''); ?>>3DS</option>
                                            </select>
                                        </div>
                                        <div>
                                            ...
                                            <select name="three_d_type" id="three_d_type"
                                                ...
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500">
                                                <option value="">Pilih Tipe</option>
                                                <option value="model" <?php echo e(old('three_d_type') === 'model' ? 'selected' : ''); ?>>Model</option>
                                                <option value="texture" <?php echo e(old('three_d_type') === 'texture' ? 'selected' : ''); ?>>Texture</option>
                                                <option value="rig" <?php echo e(old('three_d_type') === 'rig' ? 'selected' : ''); ?>>Rig</option>
                                                <option value="animation" <?php echo e(old('three_d_type') === 'animation' ? 'selected' : ''); ?>>Animation</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <input type="url" name="three_d_preview_link" id="three_d_preview_link" value="<?php echo e(old('three_d_preview_link')); ?>"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="language" class="block text-sm font-medium text-gray-700 mb-2">
                                        <?php echo e(__('messages.note_language')); ?>
                                    ...
                                    <select name="language" id="language"
                                        ...
                                        <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($code); ?>" <?php echo e(old('language')===$code ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    <label for="scheduled_publish_at" class="block text-sm font-medium text-gray-700 mb-2">
                                        <?php echo e(__('messages.scheduled_publish_at')); ?> (<?php echo e(__('messages.optional')); ?>)
                                    </label>
                                    <input type="datetime-local" name="scheduled_publish_at" id="scheduled_publish_at" value="<?php echo e(old('scheduled_publish_at')); ?>"
                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200">
                                    <p class="mt-2 text-xs text-gray-600"><?php echo e(__('messages.scheduled_publish_help')); ?></p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.content')); ?> <span class="text-red-500 font-bold" title="Wajib diisi">*</span>
                                    <span class="text-xs text-gray-500 ml-1">(Wajib)</span>
                                </label>
                                <div class="mt-1" id="editor-wrapper" style="min-height: 300px;">
                                    <div id="content-editor" style="min-height: 300px;" class="<?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-2 border-red-500 rounded-lg <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="summary" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.summary')); ?> <span class="text-xs text-gray-500">(Optional)</span>
                                </label>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('summary')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="preview-content-wrapper"
                                style="display: <?php echo e(old('price', 0) > 0 ? 'block' : 'none'); ?>;">
                                <label for="preview_content" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.preview_content')); ?> <span
                                        class="text-xs text-gray-500"><?php echo e(__('messages.preview_content_optional')); ?></span>
                                </label>
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('preview_content')); ?></textarea>
                                <p class="mt-1 text-xs text-gray-500">
                                    <span id="preview-char-count">0</span>/300 <?php echo e(__('messages.characters')); ?>.
                                    <?php if(empty(old('preview_content'))): ?>
                                        <?php echo e(__('messages.auto_generated_from_content')); ?>
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <input type="range" name="preview_percentage" id="preview_percentage"
                                            ...
                                            value="<?php echo e(old('preview_percentage', 0)); ?>"
                                            class="flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-blue-600">
                                        <div class="w-20 text-center">
                                            <span id="preview-percentage-value"
                                                class="text-lg font-semibold text-blue-600"><?php echo e(old('preview_percentage', 0)); ?></span>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label for="attachments" class="block text-sm font-medium text-gray-700 mb-2">
                                    <?php echo e(__('messages.file_attachments')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ><?php echo e(old('external_links')); ?></textarea>
                                <p class="mt-1 text-xs text-gray-500">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <!-- Content Protection -->
                            <?php echo $__env->make('notes.partials.content-protection', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                            <!-- Price and Public Toggle -->
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="price" class="block text-sm font-medium text-gray-700 mb-2">
                                        <?php echo e(__('messages.price')); ?> <span
                                            class="text-xs text-gray-500 font-normal"><?php echo e(__('messages.price_rp_0_for_free')); ?></span>
                                    </label>
                                    <div class="relative">
                                        ...
                                        <input type="number" name="price" id="price"
                                            value="<?php echo e(old('price', 0)); ?>" min="0" step="0.01" placeholder="0"
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <div class="mt-2 flex items-start gap-2">
                                        ...
                                        <p class="text-xs text-gray-600">
                                            <strong class="text-green-700"><?php echo e(__('messages.free')); ?></strong>:
                                            <?php echo e(__('messages.share_knowledge_freely')); ?> •
                                            <strong class="text-blue-700"><?php echo e(__('messages.paid')); ?></strong>:
                                            <?php echo e(__('messages.set_your_own_price')); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-4" id="discount-price-wrapper"
                                        style="display: <?php echo e(old('discount_price') || old('price', 0) > 0 ? 'block' : 'none'); ?>;">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" name="discount_price" id="discount_price"
                                                value="<?php echo e(old('discount_price')); ?>" min="0" step="0.01"
                                                placeholder="0"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mt-6">
                                        ...
                                        <div class="space-y-3">
                                            <label id="sale-mode-scarcity-label" class="flex items-start p-4 rounded-lg border-2 <?php echo e(old('sale_mode', 'scarcity') === 'scarcity' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> cursor-pointer transition-all duration-200">
                                                <input type="radio" name="sale_mode" value="scarcity" <?php echo e(old('sale_mode', 'scarcity') === 'scarcity' ? 'checked' : ''); ?>
                                                ...
                                                <div class="ml-3 flex-1">
                                                    ...
                                                    <p class="text-xs text-gray-600 mt-1">
                                                        ...
                                                        • Grace period <span id="grace-period-display"><?php echo e(old('grace_period_days', 30)); ?></span> hari untuk pembelian ulang
                                                    </p>
                                                </div>
                                            </label>
                                            <label id="sale-mode-standard-label" class="flex items-start p-4 rounded-lg border-2 <?php echo e(old('sale_mode') === 'standard' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'); ?> cursor-pointer transition-all duration-200">
                                                <input type="radio" name="sale_mode" value="standard" <?php echo e(old('sale_mode') === 'standard' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="scarcity-settings" class="mt-4 space-y-4" style="display: <?php echo e(old('sale_mode', 'scarcity') === 'scarcity' ? 'block' : 'none'); ?>;">
                                        <div>
                                            ...
                                            <input type="number" name="grace_period_days" id="grace_period_days"
                                                value="<?php echo e(old('grace_period_days', 30)); ?>" min="0" max="365" step="1"
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['grace_period_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="relist_price_multiplier" id="relist_price_multiplier"
                                                value="<?php echo e(old('relist_price_multiplier', 1.5)); ?>" min="1" max="10" step="0.1"
                                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['relist_price_multiplier'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 focus:border-red-500 focus:ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                            ...
                                            <?php $__errorArgs = ['relist_price_multiplier'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="flex items-end">
                                    <label
                                        ...
                                        <div class="ml-3">
                                            <span
                                                class="text-sm font-medium text-gray-700"><?php echo e(__('messages.make_public')); ?></span>
                                            <p class="text-xs text-gray-500 mt-0.5">
                                                <?php echo e(__('messages.available_in_marketplace')); ?></p>
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <?php if(true): ?>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <select name="folder_id" id="folder_id"
                                            ...
                                            <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($folder->id); ?>"
                                                    data-workspace-id="<?php echo e($folder->workspace_id ?? ''); ?>"
                                                    <?php echo e(old('folder_id', $selectedFolder?->id) == $folder->id ? 'selected' : ''); ?>>
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">
                                            <?php echo e(__('messages.organize_notes_in_folders')); ?></p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="workspace_id" id="workspace_id"
                                            ...
                                            <?php $__currentLoopData = $workspaces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workspace): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($workspace->id); ?>"
                                                    <?php echo e(old('workspace_id', $selectedWorkspace?->id) == $workspace->id ? 'selected' : ''); ?>>
                                                    <?php echo e($workspace->name); ?> (<?php echo e($workspace->type); ?>)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <p class="mt-1 text-xs text-gray-500"><?php echo e(__('messages.assign_to_workspace')); ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        <input type="text" id="tag-input"
                                            placeholder="<?php echo e(__('messages.type_tag_and_press_enter')); ?>"
                                    ...
                                    <div>
                                        <select id="tag-select"
                                            ...
                                            <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($tag->name); ?>"><?php echo e($tag->name); ?>

                                                    (<?php echo e($tag->notes_count); ?> notes)
                                                </option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center justify-end gap-4 pt-6 border-t border-gray-200">
                                ...
                                <button type="submit" id="submit-btn"
                                    ...
                                    <span id="submit-text"><?php echo e(__('Create Note')); ?></span>
                                </button>
                            </div>
                        </div>
                    </form>
        ...
        <?php $__env->startPush('scripts'); ?>
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    const walletTopupUrl = '<?php echo e(route('wallet.index')); ?>';
                    ...
                    if (draftCheckbox) {
                        draftCheckbox.addEventListener('change', function() {
                            if (this.checked) {
                                ...
                                submitText.textContent = '<?php echo e(__('Create Note')); ?>';
                            }
                        });
