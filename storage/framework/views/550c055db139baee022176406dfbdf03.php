    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__empty_1 = true; $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="<?php echo e($entry['user'] && auth()->check() && $entry['user']->id === auth()->id() ? 'bg-blue-50' : 'hover:bg-gray-50'); ?>">
                                    ...
                                    <?php if($entry['user']): ?>
                                        <div class="flex items-center">
                                            <?php if($entry['user']->avatar): ?>
                                                <img class="h-10 w-10 rounded-full mr-3" src="<?php echo e(Storage::url($entry['user']->avatar)); ?>" alt="<?php echo e($entry['user']->name); ?>">
                                            <?php else: ?>
                                                <div class="h-10 w-10 rounded-full bg-gray-300 mr-3 flex items-center justify-center">
                                                    <span class="text-gray-600 font-medium"><?php echo e(substr($entry['user']->name, 0, 1)); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            <div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <span class="text-lg font-bold text-gray-900"><?php echo e(number_format($entry['total_points'])); ?></span>
        ...
        <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul class="space-y-2 text-blue-800">
                <li class="flex items-start">
                    ...
                    <span><strong>Share a note:</strong> Earn 10 points every time you share a note</span>
                </li>
                <li class="flex items-start">
                    <svg class="h-5 w-5 text-blue-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                    </svg>
                    <span><strong>Get a click:</strong> Earn 5 points when someone clicks your share link</span>
                </li>
                <li class="flex items-start">
                    <svg class="h-5 w-5 text-blue-600 mr-2 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                    </svg>
                    <span><strong>Generate a purchase:</strong> Earn 50 points when someone buys through your share link</span>
                </li>
            </ul>
        </div>
        ...
        <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            ...
            <ul class="space-y-2 text-yellow-800">
                <li>🥇 <strong>Rank 1:</strong> Rp 100,000</li>
                <li>🥈 <strong>Rank 2:</strong> Rp 50,000</li>
                <li>🥉 <strong>Rank 3:</strong> Rp 25,000</li>
                <li>🏆 <strong>Rank 4-10:</strong> Rp 10,000</li>
                <li>⭐ <strong>Rank 11-50:</strong> Rp 5,000</li>
            </ul>
            <p class="text-sm text-yellow-700 mt-4">Rewards are automatically distributed at the end of each month.</p>
        </div>
        <?php endif; ?>
    </div>
</div>
