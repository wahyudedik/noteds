<?php $__env->startSection('title', __('messages.resale_note')); ?>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-2">
                <a href="<?php echo e(route('marketplace.show', $note)); ?>" class="text-gray-500 hover:text-gray-700 mr-2">
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200 mb-6">
            <div class="p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4"><?php echo e($note->title); ?></h2>
                <div class="space-y-2 text-sm text-gray-600">
                    <div class="flex items-center justify-between">
                        <span>Harga Pembelian Original:</span>
                        <span class="font-semibold text-gray-900"><?php echo e(currency($originalPrice)); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span>Harga Saat Ini:</span>
                        <span class="font-semibold text-gray-900"><?php echo e(currency($currentPrice)); ?></span>
                    </div>
                    <?php if($note->originalCreator): ?>
                        <div class="flex items-center justify-between pt-2 border-t border-gray-200">
                            <span>Original Creator:</span>
                            <span class="font-medium text-blue-600"><?php echo e($note->originalCreator->name); ?></span>
                        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            ...
            <div class="p-6">
                <form action="<?php echo e(route('notes.resale', $note)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="resale_price" id="resale_price" 
                                value="<?php echo e(old('resale_price', $currentPrice)); ?>" 
                                min="0" step="0.01" placeholder="0" required
                                class="mt-1 block w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition-all duration-200 <?php $__errorArgs = ['resale_price'];
                        ...
                        <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 text-xs text-blue-800 space-y-2">
                            <?php if(!empty($priceGuidance['min_default'])): ?>
                                <p class="flex items-center gap-2">
                                    ...
                                    <span>Harga minimum: <strong><?php echo e(currency($priceGuidance['min_default'])); ?></strong></span>
                                </p>
                            <?php endif; ?>
                            <?php if(!empty($priceGuidance['recommended_price'])): ?>
                                <p class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                                    </svg>
                                    <span>Harga rekomendasi: <strong><?php echo e(currency($priceGuidance['recommended_price'])); ?></strong></span>
                                </p>
                            <?php endif; ?>
                            <?php if(!empty($priceGuidance['original_price'])): ?>
                                <p class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <span>Harga pembelian Anda: <strong><?php echo e(currency($priceGuidance['original_price'])); ?></strong></span>
                                </p>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
