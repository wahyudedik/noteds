...
const submit = () => {
    form.post(route('clipper.profile.store'), {
        onSuccess: () => {
            // Redirect to clipper dashboard or profile
        },
    });
};
            ...
            <div class="mx-auto max-w-4xl">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
                        Setup Your Clipper Profile
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Complete your profile to start submitting clips to campaigns. Your profile helps brands discover your content and work with you.
                    </p>
                </div>
