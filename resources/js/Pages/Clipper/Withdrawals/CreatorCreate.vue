...
const submit = () => {
    form.post(route('clipper.withdrawals.creator.store'));
};
...
<template>
    <Head title="Request Creator Withdrawal" />
            ...
            <div class="mx-auto max-w-2xl">
                <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-300 mb-2">
                        ...
                        Rp {{ formatCurrency(wallet?.balance_locked) }} (in active campaigns)
                    </p>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-2">
                        <strong>Note:</strong> You can only withdraw from available balance. Locked balance will be available after campaigns are completed or cancelled.
                    </p>
                ...
                <form @submit.prevent="submit" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="space-y-4">
                        ...
                        <div class="flex justify-end space-x-4 pt-4">
                            <Link
                                :href="route('clipper.wallet.creator')"
                            ...
                            <button
                                type="submit"
                                :disabled="form.processing || !wallet?.balance_available || wallet.balance_available < minWithdrawal"
