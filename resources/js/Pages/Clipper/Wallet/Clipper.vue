    ...
    <ClipperLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link
                    :href="route('clipper.withdrawals.create')"
            ...
            <div class="mx-auto max-w-7xl space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <div class="text-sm text-gray-500 dark:text-gray-400 mb-1">Pending Balance</div>
                            <div class="text-3xl font-bold text-yellow-600 dark:text-yellow-400">
                                Rp {{ formatCurrency(wallet?.balance_pending) }}
                            </div>
                        ...
                        <div>
                            <div class="text-sm text-gray-500 dark:text-gray-400 mb-1">Total Withdrawn</div>
                            <div class="text-3xl font-bold text-gray-900 dark:text-white">
                                Rp {{ formatCurrency(wallet?.balance_withdrawn) }}
                            </div>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <Link
                            :href="route('clipper.wallet.clipper.history')"
