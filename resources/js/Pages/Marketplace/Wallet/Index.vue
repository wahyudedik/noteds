            ...
            <div class="mx-auto max-w-7xl space-y-6">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex justify-between items-start">
                        <div>
                            <p class="text-blue-100 text-sm font-medium mb-1">Current Balance</p>
                        ...
                        <svg class="h-16 w-16 text-blue-300 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                    </div>
                    <div v-if="pendingWithdrawal > 0" class="mt-4 pt-4 border-t border-blue-500">
                        <p class="text-sm text-blue-100">Pending Withdrawal: Rp {{ new Intl.NumberFormat('id-ID').format(pendingWithdrawal) }}</p>
                    </div>
                </div>
