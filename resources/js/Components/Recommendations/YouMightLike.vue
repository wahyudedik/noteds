...
const fetchData = async () => {
  loading.value = true;
  const res = await axios.get(route('recommendations.feed'), { params: { limit: 6 } });
...
<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg border p-4">
    <div class="text-sm font-semibold mb-2">You might like</div>
    ...
    <div v-else class="space-y-2">
      <Link
        ...
        class="block p-3 rounded-md bg-gray-50 hover:bg-gray-100 transition dark:bg-gray-700/40 dark:hover:bg-gray-700"
      >
