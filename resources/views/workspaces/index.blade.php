                                ...
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex-1">
                                            ...
                                            @if ($workspace->description)
                                                <p class="text-sm text-gray-600 line-clamp-2">{{ $workspace->description }}
                                                </p>
                                            @endif
                                        </div>
                                    ...
                                    <div class="flex items-center gap-4 text-sm text-gray-600">
                                        <span class="flex items-center gap-1">
                                            ...
                                            {{ $workspace->notes_count == 1 ? __('messages.note') : __('messages.notes') }}
                                        </span>
                                        <span class="flex items-center gap-1">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            {{ $workspace->members()->count() == 1 ? __('messages.member') : __('messages.members') }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="p-6">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex-1">
                                            ...
                                            <p class="text-xs text-gray-500">{{ __('messages.owner') }}:
