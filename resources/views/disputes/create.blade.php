    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4 mb-6">
                ...
                <p class="text-yellow-700 dark:text-yellow-300 text-sm mt-1">Filing a dispute will pause this order pending admin review. Please provide detailed information and evidence.</p>
            </div>

            <form action="{{ route('studio.orders.dispute.store', $order) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('studio.orders.show', $order) }}" class="px-6 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                        Cancel
                    </a>
                </div>
            </form>
