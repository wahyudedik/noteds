                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                        <div>
                                            <label for="document_type"
                                                ...
                                                {{ __('messages.document_type_label') }} <span
                                            ...
                                            <select name="document_type" id="document_type"
                                                ...
                                                <option value="ktp"
                                                    {{ old('document_type', $user->document_type ?? 'ktp') === 'ktp' ? 'selected' : '' }}>
                                                    {{ __('messages.ktp_full') }}</option>
                                                <option value="kartu_pelajar"
                                                    {{ old('document_type', $user->document_type) === 'kartu_pelajar' ? 'selected' : '' }}>
                                                    {{ __('messages.student_card') }}</option>
                                            </select>
                                            <p class="mt-1 text-xs text-gray-500">
                                                {{ __('messages.select_document_type') }}</p>
                                            @error('document_type')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                            ...
                                            <label for="ktp_file"
                                                ...
                                                {{ __('messages.upload_identity_document') }} <span
                                                    class="text-red-500">*</span>
                                            </label>
                                            @if ($user->ktp_path)
                                                <div class="mb-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                                                    <p class="text-sm text-green-800">
                                                        ✓
                                                        {{ $user->document_type === 'kartu_pelajar' ? __('messages.student_card_short') : __('messages.ktp_short') }}
                                                        {{ __('messages.already_uploaded') }}
                                                    </p>
                                                    <p class="text-xs text-green-600 mt-1">
                                                        {{ __('messages.status_label') }}
                                                        {{ ucfirst($user->verification_status ?? 'pending') }}</p>
                                                </div>
                                            @else
                                                <div class="mb-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                                    <p class="text-sm text-yellow-800">⚠
                                                        {{ __('messages.document_not_uploaded') }}</p>
                                                </div>
                                            @endif
                                            <input type="file" name="ktp_file" id="ktp_file"
                                                accept=".jpg,.jpeg,.png,.pdf"
                                                class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                                            <p class="mt-1 text-xs text-gray-500">{{ __('messages.file_format_help') }}
                                            </p>
                                            @error('ktp_file')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div>
                                            ...
                                            @if ($user->selfie_path)
                                                <div class="mb-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                                                    <p class="text-sm text-green-800">✓
                                                        {{ __('messages.selfie_already_uploaded') }}</p>
                                                    <p class="text-xs text-green-600 mt-1">
                                                        {{ __('messages.status_label') }}
                                                        {{ ucfirst($user->verification_status ?? 'pending') }}</p>
                                                </div>
                                            @else
                                                <div class="mb-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                                    <p class="text-sm text-yellow-800">⚠
                                                        {{ __('messages.selfie_not_uploaded') }}</p>
                                                </div>
                                            @endif
                                            <input type="file" name="selfie_file" id="selfie_file"
                                                accept=".jpg,.jpeg,.png"
                                                class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                                            <p class="mt-1 text-xs text-gray-500">{{ __('messages.selfie_upload_help') }}
                                            </p>
                                            @error('selfie_file')
                                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                            @enderror
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="bank_account_number" id="bank_account_number"
                                            ...
                                            placeholder="{{ __('messages.account_number') }}" maxlength="50"
                                ...
                                @if (session('status') === 'profile-updated')
                                    (function() {
                                        if (typeof window.showSuccess === 'function') {
                                            window.showSuccess(@json(__('messages.saved_successfully')));
                                        } else {
