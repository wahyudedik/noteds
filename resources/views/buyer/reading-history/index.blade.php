                        ...
                        @foreach($viewHistory as $view)
                            <div class="flex items-start gap-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                                ...
                                <div class="flex-shrink-0">
                                    @if($view->note->hasThumbnails())
                                        <img src="{{ Storage::url($view->note->thumbnails[0]) }}" 
                                             alt="{{ $view->note->title }}"
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-start justify-between gap-4">
                                        <div class="flex-1">
                                            ...
                                            @if($view->note->summary)
                                                <p class="mt-1 text-sm text-gray-600 line-clamp-2">{{ $view->note->summary }}</p>
                                            @endif
