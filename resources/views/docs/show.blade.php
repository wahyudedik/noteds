    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                <li><a href="{{ route('docs.index') }}" class="hover:text-blue-600 transition-colors duration-200">{{ __('messages.documentation') }}</a></li>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 mb-6">
            ...
            <div class="flex flex-wrap items-center gap-4 pt-4 border-t border-gray-200 text-sm text-gray-600">
                ...
                <div class="flex items-center">
                    ...
                    {{ number_format($documentation->view_count) }} {{ $documentation->view_count == 1 ? __('messages.view') : __('messages.views') }}
                </div>
            </div>
