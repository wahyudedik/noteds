                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($leaderboard as $entry)
                            <tr class="{{ $entry['user'] && auth()->check() && $entry['user']->id === auth()->id() ? 'bg-blue-50' : 'hover:bg-gray-50' }}">
                                    ...
                                    @if($entry['user'])
                                        <div class="flex items-center">
                                            @if($entry['user']->avatar)
                                                <img class="h-10 w-10 rounded-full mr-3" src="{{ Storage::url($entry['user']->avatar) }}" alt="{{ $entry['user']->name }}">
                                            @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <span class="text-lg font-bold text-gray-900">{{ number_format($entry['total_points']) }}</span>
