    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if($faqs->isEmpty())
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                ...
                <p class="mt-2 text-gray-600">Check back later for frequently asked questions.</p>
            </div>
        @else
            <div class="space-y-4">
                @foreach($faqs as $faq)
        ...
        <div class="mt-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-center text-white">
            ...
            <p class="text-blue-100 mb-6">Can't find what you're looking for? We're here to help!</p>
