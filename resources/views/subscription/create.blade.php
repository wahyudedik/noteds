...
<div class="py-8 sm:py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-base text-gray-600">Request premium access with unlimited features</p>
        </div>
                ...
                <form action="{{ route('subscription.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="payment_proof" class="block text-sm font-medium text-gray-700 mb-2">
                            Payment Proof URL <span class="text-red-500">*</span>
                        </label>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Upload proof of payment (screenshot or image URL) showing successful payment for premium subscription</p>
                        @error('payment_proof')
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div class="flex-1">
                                <h3 class="text-sm font-medium text-blue-900 mb-1">Note</h3>
                                <p class="text-sm text-blue-800">After submitting your request with payment proof, our admin team will review and approve your premium subscription. You'll receive a notification once approved.</p>
                            </div>
                        </div>
                    </div>
