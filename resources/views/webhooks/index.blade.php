    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($webhooks as $webhook)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ str_replace('.', ' ', $webhook->event) }}</div>
                                </td>
                                <td class="px-6 py-4">
        ...
        @else
            <div class="bg-white rounded-lg shadow-sm p-12 text-center">
                ...
                <p class="mt-2 text-sm text-gray-500">{{ __('Create your first webhook to receive real-time notifications.') }}</p>
                <a href="{{ route('webhooks.create') }}" class="mt-4 inline-block text-sm text-blue-600 hover:text-blue-800">
                    {{ __('Create Webhook') }} →
                </a>
            </div>
        @endif
