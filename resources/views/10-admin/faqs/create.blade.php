        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 md:p-8">
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">Question</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-900 mb-2">Answer</label>
                        <textarea name="answer" rows="6"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 resize-none" required>{{ old('answer') }}</textarea>
                    </div>
