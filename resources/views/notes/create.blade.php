        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg border border-gray-200">
            ...
            <form action="{{ route('notes.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <!-- AI Assistant -->
                    <div class="flex items-start gap-3 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                        <div class="flex-shrink-0">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-600 mb-3">Let AI help you generate a summary and suggest tags</p>
                            <button type="button" id="ai-analyze-btn" class="inline-flex items-center px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                </svg>
                                <span id="ai-btn-text">Generate with AI</span>
                                <svg id="ai-loading" class="hidden w-4 h-4 ml-2 animate-spin" fill="none" viewBox="0 0 24 24">
                    ...
                    <div>
                        <label for="summary" class="block text-sm font-medium text-gray-700 mb-2">
                            Summary <span class="text-xs text-gray-500">(Optional - AI can generate this)</span>
                        </label>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Brief summary of your note (recommended for better marketplace visibility)</p>
                        @error('summary')
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">
                            <span id="preview-char-count">0</span>/300 characters. 
                            @if(empty(old('preview_content'))) Auto-generated from content if left empty. @endif
                        </p>
                    ...
                    <div>
                        ...
                        @if(!auth()->user()->hasPremium())
                            <p class="mt-2 text-xs text-yellow-600 flex items-center">
                                ...
                                File size limit: 5MB for Basic users. <a href="{{ route('subscription.create') }}" class="font-semibold hover:underline">Upgrade to Premium</a> for 50MB per file.
                            </p>
                        @endif
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-end">
                            <label class="flex items-center p-4 rounded-lg border border-gray-200 hover:border-blue-300 cursor-pointer transition-colors duration-200 w-full">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const previewContentDiv = previewContentTextarea?.closest('div');
    if (priceInput && previewContentDiv) {
        priceInput.addEventListener('input', function() {
            if (parseFloat(this.value) > 0) {
                previewContentDiv.style.display = 'block';
            } else {
                previewContentDiv.style.display = 'none';
            }
        });
        // Initial check
