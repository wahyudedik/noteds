                ...
                <div class="flex justify-between items-start mb-6">
                    ...
                    <div class="flex gap-2 ml-4">
                        ...
                        @if($hasTransactions ?? false)
                            <div class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-500 bg-gray-50 cursor-not-allowed" title="{{ __('messages.cannot_delete_sold_tooltip') }}">
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
