...
<head>
    ...
    <title>Daily Digest - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        ...
        <p style="margin-top: 30px; color: #6b7280; font-size: 14px;">
            ...
            <a href="{{ route('notifications.preferences.index') }}" style="color: #667eea;">Manage your preferences</a> to change this.
        </p>
    </div>
    ...
    <div class="footer">
        ...
        <p>
            <a href="{{ route('notifications.preferences.index') }}" style="color: #667eea;">Notification Preferences</a> | 
            <a href="{{ url('/') }}" style="color: #667eea;">Visit Website</a>
        </p>
    </div>
</body>
</html>
