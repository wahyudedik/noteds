...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    ...
                    <div class="p-6">
                        <form id="earnings-form" class="space-y-4">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.note_price') }}</label>
                                <input type="number" id="earnings-price" name="price" value="50000" min="0"
                                    step="1000"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.sales_per_month') }}</label>
                                <input type="number" id="earnings-sales" name="sales" value="10" min="0"
                                    step="1"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500">
                            </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        <h4 class="text-lg font-bold text-green-800 mb-2">
                                            {{ __('messages.your_potential_earnings') }}</h4>
                                        <div class="space-y-2">
                ...
                <div
                    ...
                    <div class="p-6">
                        <form id="referral-form" class="space-y-4">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.total_referrals') }}</label>
                                <input type="number" id="referral-count" name="count" value="20" min="0"
                                    step="1"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
                            </div>
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.avg_transaction') }}</label>
                                <input type="number" id="referral-transaction" name="transaction" value="50000"
                                    min="0" step="1000"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-2 focus:ring-purple-500">
                            </div>
                        ...
                        <div id="referral-result" class="mt-6 hidden">
                            <div class="bg-purple-50 border-l-4 border-purple-500 p-4 rounded-r-lg">
                                <div class="flex items-start">
                                    <svg class="w-6 h-6 text-purple-500 mr-3 mt-0.5" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <div class="flex-1">
                                        <h4 class="text-lg font-bold text-purple-800 mb-2">
                                            {{ __('messages.your_referral_rewards') }}</h4>
                                        <div class="space-y-2">
                                            <div class="flex justify-between">
                                            ...
                                            <div class="flex justify-between">
                                                <span
                                                    class="text-gray-700">{{ __('messages.transaction_commissions') }}:</span>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-2 border-gray-200 rounded-lg p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span
                                        class="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium">{{ __('messages.free') }}</span>
                                </div>
                                ...
                                <a href="{{ route('register') }}"
                                    class="block w-full bg-gray-600 hover:bg-gray-700 text-white text-center font-semibold py-2 rounded-lg transition-all duration-200">
                            ...
                            <!-- Premium Plan -->
                            <div
                                class="border-2 border-green-500 rounded-lg p-4 bg-gradient-to-br from-green-50 to-transparent relative">
                                <div
                                    class="absolute top-0 right-0 bg-green-500 text-white px-3 py-1 rounded-bl-lg rounded-tr-lg text-xs font-bold">
                                ...
                                <div class="flex items-center justify-between mb-3 mt-2">
                                    ...
                                    <span
                                        class="px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm font-medium">{{ \App\Models\Setting::formatPremiumPrice(true) }}</span>
                                </div>
                                <div class="space-y-2 mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="text-sm text-gray-700 font-medium">{{ __('messages.unlimited_notes') }}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                        ...
                                        <span
                                            class="text-sm text-gray-700 font-medium">{{ __('messages.priority_support') }}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                        ...
                                        <span
                                            class="text-sm text-gray-700 font-medium">{{ __('messages.featured_in_marketplace') }}</span>
                                    </div>
                                    <div class="flex items-center">
                                        <svg class="w-5 h-5 text-green-600 mr-2" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                        ...
                                        <span
                                            class="text-sm text-gray-700 font-medium">{{ __('messages.advanced_analytics') }}</span>
                                    </div>
                                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <form id="wallet-form" class="space-y-4">
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.topup_amount') }}</label>
                                <input type="number" id="wallet-topup" name="topup" value="100000" min="10000"
                                    step="10000"
                                    class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500">
                            </div>
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.withdraw_amount') }}</label>
                                <input type="number" id="wallet-withdraw" name="withdraw" value="50000"
                        ...
                        <div id="wallet-history" class="mt-6 space-y-2 max-h-40 overflow-y-auto">
                            <p class="text-xs text-gray-500 text-center">
                                {{ __('messages.transaction_history_will_appear') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-pink-500 to-pink-600 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-xl font-bold text-white mb-2">{{ __('messages.marketplace_preview') }}
                                </h3>
                        ...
                        <div class="space-y-4">
                            <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors cursor-pointer"
                                ...
                                <div class="flex items-start justify-between mb-2">
                                    ...
                                    <span
                                        class="px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-medium">{{ __('messages.free') }}</span>
                                </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span
                                            class="text-xs text-gray-500">{{ __('messages.reviews_with_count', ['count' => 15]) }}</span>
                                    </div>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p class="text-xs text-blue-800">
                                    <strong>{{ __('messages.marketplace_features') }}</strong>
                                    {{ __('messages.marketplace_features_desc') }}
                                </p>
                            </div>
                            <a href="{{ route('marketplace.index') }}"
                                class="block w-full bg-pink-600 hover:bg-pink-700 text-white text-center font-semibold py-2 rounded-lg transition-all duration-200">
                ...
                <div
                    ...
                    <div class="bg-gradient-to-r from-violet-500 to-violet-600 p-6">
                        <div class="flex items-center justify-between">
                            ...
                            <svg class="w-12 h-12 text-violet-200" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="p-6">
                        <div class="mb-4">
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.your_note_price') }}</label>
                        ...
                        <div class="mb-4">
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.category') }}</label>
                        ...
                        <div id="benchmark-result" class="mt-6 hidden">
                            <div class="bg-violet-50 border-l-4 border-violet-500 p-4 rounded-r-lg">
                                <h4 class="text-lg font-bold text-violet-800 mb-3">{{ __('messages.market_analysis') }}
                                </h4>
                                <div class="space-y-2">
                                    <div class="flex justify-between">
            ...
            <div
                ...
                <div class="bg-gradient-to-r from-teal-500 to-teal-600 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-xl font-bold text-white mb-2">{{ __('messages.income_growth_projector') }}
                            </h3>
                            <p class="text-teal-100 text-sm">{{ __('messages.project_12_month_income') }}</p>
                        </div>
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-3">{{ __('messages.number_of_notes') }}</label>
                            <div class="space-y-2">
                                <input type="range" id="igp-notes" name="notes" value="5" min="1"
                                    max="50"
                                    class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                                <div class="flex items-center justify-between">
                                    <span class="text-2xl font-bold text-teal-600" id="igp-notes-display">5</span>
                                    <span class="text-sm text-gray-500">{{ __('messages.notes_max') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-3">{{ __('messages.avg_sales_per_month') }}</label>
                            <div class="space-y-2">
                                <input type="range" id="igp-sales" name="sales" value="5" min="1"
                                    max="100"
                                    class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                                <div class="flex items-center justify-between">
                                    <span class="text-2xl font-bold text-teal-600" id="igp-sales-display">5</span>
                                    <span class="text-sm text-gray-500">{{ __('messages.sales_per_month') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-3">{{ __('messages.monthly_growth_rate') }}</label>
                            <div class="space-y-2">
                                <input type="range" id="igp-growth" name="growth" value="5" min="0"
                                    max="20" step="0.5"
                                    class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer">
                                <div class="flex items-center justify-between">
                                    <span class="text-2xl font-bold text-teal-600" id="igp-growth-display">5.0%</span>
                                    <span class="text-sm text-gray-500">{{ __('messages.growth_per_month') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-8">
                        ...
                        <input type="number" id="igp-price" value="50000" min="10000" step="5000"
                            class="w-full rounded-lg border-gray-300 shadow-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500">
                    </div>

                    <!-- Calculate Button -->
                    <button type="button" id="igp-calculate"
                        class="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-lg transition-all duration-200">
                        {{ __('messages.project_income') }}
                    </button>

                    <!-- Results Section -->
                    <div id="igp-results" class="mt-8 hidden">
                        <!-- Summary Cards -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            <div class="bg-teal-50 rounded-lg p-4 border-l-4 border-teal-500">
                                <p class="text-sm text-gray-600 mb-1">{{ __('messages.monthly_income_month_1') }}</p>
                                <p class="text-2xl font-bold text-teal-700" id="igp-month-1"></p>
                            </div>
                            <div class="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                                <p class="text-sm text-gray-600 mb-1">{{ __('messages.monthly_income_month_6') }}</p>
                                <p class="text-2xl font-bold text-blue-700" id="igp-month-6"></p>
                            </div>
                            <div class="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
                                <p class="text-sm text-gray-600 mb-1">{{ __('messages.total_yearly_income') }}</p>
                                <p class="text-2xl font-bold text-green-700" id="igp-yearly"></p>
                            </div>
                        </div>

                        <!-- Chart Container -->
                        <div class="bg-gray-50 rounded-lg p-6 mb-8">
                            <h4 class="text-lg font-bold text-gray-900 mb-4">{{ __('messages.income_projection_chart') }}
                            </h4>
                            <canvas id="igp-chart" height="80"></canvas>
                        </div>
                                    ...
                                    <thead class="bg-gray-100 border-b border-gray-200">
                                        <tr>
                                            <th class="px-4 py-3 text-left font-semibold text-gray-700">
                                                {{ __('messages.month') }}</th>
                                            <th class="px-4 py-3 text-right font-semibold text-gray-700">
                                                {{ __('messages.monthly_sales') }}</th>
                                            <th class="px-4 py-3 text-right font-semibold text-gray-700">
                                                {{ __('messages.gross_income') }}</th>
                                            <th class="px-4 py-3 text-right font-semibold text-gray-700">
                                                {{ __('messages.platform_fee') }}</th>
                                            <th class="px-4 py-3 text-right font-semibold text-gray-700">
                                                {{ __('messages.net_income') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody id="igp-table" class="divide-y divide-gray-200">
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                referralForm.addEventListener('click', function() {
                    ...
                    const avgTransaction = parseFloat(document.getElementById('referral-transaction').value) ||
                        0;
                ...
                document.getElementById('earnings-price').addEventListener('input', function() {
                    if (document.getElementById('earnings-price').value && document.getElementById(
                            'earnings-sales').value) {
                        earningsForm.click();
                    }
                });
                ...
                document.getElementById('referral-count').addEventListener('input', function() {
                    if (document.getElementById('referral-count').value && document.getElementById(
                            'referral-transaction').value) {
                        referralForm.click();
                    }
                });
        ...
        `).join('');
                    ...
                    function activateStep(stepIndex) {
                        steps.forEach((step, index) => {
                            if (index <= stepIndex) {
                                ...
                                step.querySelector('div').classList.remove('bg-gray-200',
                                    'text-gray-600');
                                step.querySelector('div').classList.add('bg-orange-100',
                                    'text-orange-600');
                            } else {
                                step.classList.add('opacity-50');
                                step.querySelector('div').classList.remove('bg-orange-100',
                                    'text-orange-600');
                ...
                const igpSalesInput = document.getElementById('igp-sales');
                const igpGrowthInput = document.getElementById('igp-growth');
                const igpPriceInput = document.getElementById('igp-price');

                // Update display values
                igpNotesInput.addEventListener('input', function() {
                    document.getElementById('igp-notes-display').textContent = this.value;
                });
                igpSalesInput.addEventListener('input', function() {
                    document.getElementById('igp-sales-display').textContent = this.value;
                });
                igpGrowthInput.addEventListener('input', function() {
                    document.getElementById('igp-growth-display').textContent = (parseFloat(this.value))
                        .toFixed(1) + '%';
                });

                document.getElementById('igp-calculate').addEventListener('click', function() {
                    const notes = parseInt(igpNotesInput.value) || 1;
                    const baseSalesPerMonth = parseInt(igpSalesInput.value) || 1;
                    const growthRate = parseFloat(igpGrowthInput.value) / 100 || 0;
                    const notePrice = parseFloat(igpPriceInput.value) || 50000;
                    ...
                    for (let month = 1; month <= 12; month++) {
                        ...
                        const monthlySalesPerNote = baseSalesPerMonth * Math.pow(1 + growthRate, month - 1);
                        const totalMonthlySales = monthlySalesPerNote * notes;

                        // Calculate income
                        const grossIncome = totalMonthlySales * notePrice;
                        const platformFee = grossIncome * platformFeePercentage;
                        ...
                        totalYearlyIncome += netIncome;
                    }

                    // Display summary cards
                    document.getElementById('igp-month-1').textContent = formatCurrency(projections[0]
                        .netIncome);
                    document.getElementById('igp-month-6').textContent = formatCurrency(projections[5]
                        .netIncome);
                    document.getElementById('igp-yearly').textContent = formatCurrency(totalYearlyIncome);

                    // Generate table rows
                    const tableBody = document.getElementById('igp-table');
                    tableBody.innerHTML = projections.map((p, idx) => `
            <tr class="${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-teal-50 transition-colors">
                <td class="px-4 py-3 font-medium text-gray-900">{{ __('messages.month') }} ${p.month}</td>
                <td class="px-4 py-3 text-right text-gray-700">${p.monthlySales.toFixed(1)} sales</td>
                <td class="px-4 py-3 text-right text-gray-900 font-medium">${formatCurrency(p.grossIncome)}</td>
                <td class="px-4 py-3 text-right text-red-600">-${formatCurrency(p.platformFee)}</td>
                <td class="px-4 py-3 text-right font-bold text-green-700">${formatCurrency(p.netIncome)}</td>
            </tr>
        `).join('');

                    // Draw chart using Canvas
                    const chartCanvas = document.getElementById('igp-chart');
                    const ctx = chartCanvas.getContext('2d');

                    drawIncomeChart(ctx, projections, chartCanvas);

                    // Show results
                    document.getElementById('igp-results').classList.remove('hidden');
                });

                // Simple canvas chart for income projection
                function drawIncomeChart(ctx, projections, canvas) {
                    const padding = 60;
                    const chartWidth = canvas.width - padding * 2;
                    const chartHeight = canvas.height - padding * 2;
                    ...
                    const maxNetIncome = Math.max(...projections.map(p => p.netIncome));
                    const scaleFactor = chartHeight / maxNetIncome;
                    ...
                    projections.forEach((p, idx) => {
                        const x = padding + (chartWidth / 11) * idx;
                        const y = canvas.height - padding - (p.netIncome * scaleFactor);
                    ...
                    for (let i = 0; i < projections.length; i += 2) {
                        ...
                        ctx.fillText('M' + projections[i].month, x, canvas.height - padding + 20);
                    }
