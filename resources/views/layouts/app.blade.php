...
<body
    class="font-sans antialiased bg-gray-50 dark:bg-gray-900 overflow-x-hidden transition-colors duration-200 {{ request()->routeIs('notes.create') ? 'create-note-page' : '' }} {{ request()->routeIs('notes.edit') ? 'edit-note-page' : '' }}">
                        ...
                        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                                ...
                                <div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <li>
                                            <a href="{{ route('cms.show', ['cmsPage' => 'privacy-policy']) }}"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                                {{ __('messages.privacy_policy') }}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ route('cms.show', ['cmsPage' => 'terms-and-conditions']) }}"
                                                class="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                            ...
                            <div class="border-t border-gray-200 dark:border-gray-700 pt-8">
                                <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                                    &copy; {{ date('Y') }} {{ config('app.name', 'Noteds') }}.
