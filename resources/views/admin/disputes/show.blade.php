                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                        <div class="flex justify-between items-start mb-6">
                            <div>
                                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Dispute #{{ $dispute->id }}
                                </h2>
                        ...
                        <div class="grid grid-cols-3 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900 dark:text-white">
                                    ${{ number_format($dispute->serviceOrder->total_amount, 2) }}</p>
                                <p class="text-xs text-gray-500 dark:text-gray-500 mt-1">
                                    {{ $dispute->serviceOrder->currency }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    @if ($dispute->evidence->count() > 0)
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                            <h3 class="font-semibold text-gray-900 dark:text-white mb-4">Evidence
                                ({{ $dispute->evidence->count() }})</h3>
                            <div class="space-y-3">
                    ...
                    @if ($dispute->isResolved())
                        <div
                            ...
                            <div class="space-y-2 text-sm text-green-900 dark:text-green-200">
                                ...
                                <p><strong>By:</strong> {{ $dispute->resolver->name }} on
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 sticky top-6">
                            ...
                            <form action="{{ route('admin.disputes.resolve', $dispute) }}" method="POST"
                                ...
                                <div>
                                    ...
                                    <textarea name="notes" id="notes" rows="4" placeholder="Document your decision reasoning..."
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                                </div>
                            ...
                            <div
                                ...
                                <p class="text-xs text-blue-900 dark:text-blue-200">
                                    <strong>Note:</strong> Refunding buyer or paying vendor will trigger automatic wallet
                                    updates with notifications to both parties.
                                </p>
                            </div>
                        </div>
                    </div>
