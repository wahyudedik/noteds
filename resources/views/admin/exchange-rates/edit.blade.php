...
<div class="py-8 sm:py-12">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Edit Exchange Rate</h1>
            ...
            <form action="{{ route('admin.exchange-rates.update', $exchangeRate) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-sm font-medium text-gray-700">From Currency</p>
                        <p class="mt-1 text-lg font-semibold text-gray-900">{{ $exchangeRate->from_currency }}</p>
                    </div>

                    <div class="bg-gray-50 p-4 rounded-lg">
                        <p class="text-sm font-medium text-gray-700">To Currency</p>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Current rate: {{ number_format($exchangeRate->rate, 4) }}</p>
                        @error('rate')
