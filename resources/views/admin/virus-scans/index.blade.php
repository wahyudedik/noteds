    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="text-2xl font-bold text-orange-600">{{ number_format($statistics['quarantined']) }}
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="text-2xl font-bold text-gray-900">
                                {{ number_format($statistics['infection_rate'], 2) }}%</div>
                        </div>
                    </div>
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('admin.virus-scans.index') }}"
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full rounded-md border-gray-300 shadow-sm">
                                ...
                                <option value="infected" {{ request('status') === 'infected' ? 'selected' : '' }}>Infected
                                </option>
                        ...
                        <div class="md:col-span-4 flex gap-2">
                            ...
                            <a href="{{ route('admin.virus-scans.index') }}"
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($scans as $scan)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $scan->scannedByUser->name ?? 'System' }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('admin.virus-scans.show', $scan) }}"
