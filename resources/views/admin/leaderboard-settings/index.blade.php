...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-6xl mx-auto">
            ...
            <form method="POST" action="{{ route('admin.leaderboard-settings.update') }}" class="space-y-6">
                @csrf
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                @error('share_points_per_purchase')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                @error('leaderboard_monthly_point_cap')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @error('leaderboard_monthly_target')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="flex items-end">
                                <label
                                    ...
                                    <input type="checkbox" id="duplicate_share_prevention"
                                        ...
                                        {{ $settingsData['duplicate_share_prevention'] ? 'checked' : '' }}
                            ...
                            <div class="flex items-end">
                                <label
                                    ...
                                    <input type="checkbox" id="auto_transfer_rewards" name="auto_transfer_rewards"
                                        value="1" {{ $settingsData['auto_transfer_rewards'] ? 'checked' : '' }}
                    ...
                    <div class="p-6">
                        <label
                            ...
                            <input type="checkbox" id="leaderboard_enabled" name="leaderboard_enabled" value="1"
                                {{ $settingsData['leaderboard_enabled'] ? 'checked' : '' }}
