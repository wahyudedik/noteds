    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p class="mt-2 text-base text-gray-600">Manage social media links displayed in the footer</p>
                </div>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex items-center justify-end gap-2">
                                            <a href="{{ route('admin.social-media.edit', $link) }}" class="text-green-600 hover:text-green-900" title="Edit">
        ...
        @else
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 text-center py-16 px-6">
                ...
                <h3 class="mt-4 text-lg font-medium text-gray-900">No social media links found</h3>
                <p class="mt-2 text-sm text-gray-500">Get started by adding your first social media link.</p>
                <div class="mt-6">
