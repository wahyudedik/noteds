...
@section('title', __('messages.admin_add_social_media'))
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">{{ __('messages.admin_add_social_media') }}</h1>
                    <p class="mt-2 text-base text-gray-600">{{ __('messages.add_new_social_link') }}</p>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="icon" id="icon" rows="4"
                        ...
                        class="w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('icon') }}</textarea>
