                            ...
                            <form action="{{ route('admin.settings.update') }}" method="POST" class="space-y-4">
                                        ...
                                        <div class="flex items-center justify-between border rounded-lg p-3">
                                            <div>
                                                ...
                                                <div class="text-xs text-gray-500">
                                                    {{ __('messages.send_email_on_event') }}</div>
                                            </div>
                                            <div>
                                ...
                                <div class="mt-6 border-t pt-4">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        {{ __('messages.sla_funding_reminder_description') }}</p>
                                </div>
                                <div class="flex items-center justify-end pt-4 border-t border-gray-200">
                                    <button type="submit"
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            @forelse ($categoryMinPriceRules as $rule)
                                                <tr>
                                                    ...
                                                    <td class="px-4 py-2">
                                                        <form
                                                            action="{{ route('admin.price-rules.update', $rule['tag_slug']) }}"
                                                    ...
                                                    <td class="px-4 py-2 text-right">
                                                        <form
                                                            action="{{ route('admin.price-rules.destroy', $rule['tag_slug']) }}"
                                                            method="POST"
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 mb-6">
                        ...
                        <div class="p-6">
                            <form action="{{ route('admin.settings.update') }}" method="POST" class="space-y-6">
                                ...
                                <p class="text-xs text-gray-500 ml-7">{{ __('messages.when_enabled_backups_uploaded') }}
                                </p>
                                    ...
                                    <div>
                                        ...
                                        <select name="s3_provider" id="s3_provider"
                                            ...
                                            <option value="wasabi"
                                                ...
                                                Wasabi</option>
                                            <option value="other"
                                                {{ $s3Settings->get('s3_provider')?->value === 'other' ? 'selected' : '' }}>
                                                Other
                            ...
                            <form action="{{ route('admin.settings.update') }}" method="POST" class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p class="mt-2 text-xs text-gray-500">
                                            Current price:
                                            <strong>{{ \App\Models\Setting::formatPremiumPrice(false) }}</strong>
                                        </p>
                                    </div>
                                        ...
                                        <div class="border border-gray-200 rounded-lg p-4">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                @foreach ($featuredDurations as $duration)
                                                    <div>
                                                        <label
                                                            for="featured_price_{{ $location }}_{{ $duration }}"
                                                            class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <div class="flex items-center justify-between border rounded-lg p-3">
                                <div>
                                    <div class="text-sm font-medium text-gray-800">
                                        {{ __('messages.enable_google_translate_api') ?? 'Enable Google Translate API' }}
                                    </div>
                                    <div class="text-xs text-gray-500">
                                        {{ __('messages.send_email_on_event') ?? 'Automatically translate chat messages' }}
                                    </div>
                                </div>
                                <div>
                                ...
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <div class="flex gap-3">
                                        ...
                                        <p class="text-sm text-blue-800">
                                            <strong>{{ __('messages.note') ?? 'Note' }}:</strong> API key will be
                                            encrypted and
