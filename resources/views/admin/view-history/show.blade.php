...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.view-history.index') }}" class="text-blue-600 hover:text-blue-800">← {{ __('messages.back_to_view_history') }}</a>
        </div>
        ...
        @if($relatedViews->count() > 0)
            <div class="bg-white shadow-sm rounded-lg p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">{{ __('messages.related_views') }} ({{ __('messages.same_ip_fingerprint') }})</h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">{{ __('messages.viewed_at') }}</th>
                            </tr>
                        </thead>
