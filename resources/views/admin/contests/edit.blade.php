                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" required
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $contest->description) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="type" id="type" required
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <option value="monthly" {{ old('type', $contest->type) === 'monthly' ? 'selected' : '' }}>Monthly Challenge</option>
                                    <option value="themed" {{ old('type', $contest->type) === 'themed' ? 'selected' : '' }}>Themed Contest</option>
                                    <option value="custom" {{ old('type', $contest->type) === 'custom' ? 'selected' : '' }}>Custom Contest</option>
                                </select>
                            </div>

                            <div id="theme-field" style="{{ old('type', $contest->type) === 'themed' ? 'display: block;' : 'display: none;' }}">
                                <label for="theme" class="block text-sm font-medium text-gray-700 mb-2">
                                    Theme
                                </label>
                                <input type="text" name="theme" id="theme" value="{{ old('theme', $contest->theme) }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                <option value="draft" {{ old('status', $contest->status) === 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="open" {{ old('status', $contest->status) === 'open' ? 'selected' : '' }}>Open</option>
                                <option value="voting" {{ old('status', $contest->status) === 'voting' ? 'selected' : '' }}>Voting</option>
                                <option value="closed" {{ old('status', $contest->status) === 'closed' ? 'selected' : '' }}>Closed</option>
                            </select>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="datetime-local" name="start_date" id="start_date" 
                                    value="{{ old('start_date', $contest->start_date ? $contest->start_date->format('Y-m-d\TH:i') : '') }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="end_date" id="end_date"
                                    value="{{ old('end_date', $contest->end_date ? $contest->end_date->format('Y-m-d\TH:i') : '') }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="datetime-local" name="voting_start_date" id="voting_start_date"
                                    value="{{ old('voting_start_date', $contest->voting_start_date ? $contest->voting_start_date->format('Y-m-d\TH:i') : '') }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="voting_end_date" id="voting_end_date"
                                    value="{{ old('voting_end_date', $contest->voting_end_date ? $contest->voting_end_date->format('Y-m-d\TH:i') : '') }}"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_entries_per_user" id="max_entries_per_user" 
                                value="{{ old('max_entries_per_user', $contest->max_entries_per_user) }}" min="1" required
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="prizes_json" id="prizes_json" rows="6"
                                ...
                                placeholder='[{"position": 1, "type": "cash", "value": 100}, {"position": 2, "type": "badge", "badge_id": "..."}]'>{{ old('prizes_json', $contest->prizes ? json_encode($contest->prizes, JSON_PRETTY_PRINT) : '') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="rules_text" id="rules_text" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Rule 1&#10;Rule 2&#10;Rule 3">{{ old('rules_text', $contest->rules ? implode("\n", $contest->rules) : '') }}</textarea>
                        </div>
