...
@section('title', 'Certification Applications')
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.certifications.index') }}" class="text-blue-600 hover:text-blue-800">← Back to Certifications</a>
        </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($applications as $application)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $application->certification->name }}</div>
                                    <div class="text-sm text-gray-500">{{ $application->certification->category }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.certifications.applications.show', $application) }}" 
