                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="color" name="color" id="color" value="{{ old('color', '#667eea') }}"
                        ...
                        <div>
                            ...
                            <textarea name="requirements_text" id="requirements_text" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                placeholder="Minimum 10 sales&#10;Average rating 4.5+&#10;Active for 6 months">{{ old('requirements_text') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="benefits" id="benefits" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('benefits') }}</textarea>
                        </div>

                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="requires_application" value="1" {{ old('requires_application', true) ? 'checked' : '' }}
