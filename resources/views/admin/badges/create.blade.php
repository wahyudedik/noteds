                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="criteria_type" id="criteria_type"
                                    ...
                                    <option value="sales_count" {{ old('criteria_type') === 'sales_count' ? 'selected' : '' }}>Sales Count</option>
                                    <option value="rating" {{ old('criteria_type') === 'rating' ? 'selected' : '' }}>Rating</option>
                                    <option value="helpful_reviews" {{ old('criteria_type') === 'helpful_reviews' ? 'selected' : '' }}>Helpful Reviews</option>
                                    <option value="activity" {{ old('criteria_type') === 'activity' ? 'selected' : '' }}>Activity</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="criteria_value" id="criteria_value" value="{{ old('criteria_value') }}" min="0"
                                    class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
