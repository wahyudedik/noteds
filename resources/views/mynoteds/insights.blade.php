...
<div class="py-8 sm:py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Get automatic insights, weekly summaries, and topic detection from your notes.</p>
        </div>
            ...
            <div class="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                ...
                <div class="text-sm text-gray-600 mt-1">
                    @if(isset($statistics['most_active_day']['date']))
                        Most Active: {{ \Carbon\Carbon::parse($statistics['most_active_day']['date'])->format('M d') }}
                    @else
                        Most Active Day
                    @endif
                </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6 mb-6">
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        ...
                        <h2 class="text-xl font-bold text-gray-900">Weekly Summary</h2>
                    </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-200 flex items-center justify-between">
                    <div class="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span>Based on {{ $weeklySummary['notes_count'] ?? 0 }} notes this week</span>
                    </div>
                </div>
            </div>
        @else
            <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-r-lg p-6 mb-6">
                <p class="text-yellow-800">
                    <strong>Note:</strong> Weekly summary will be generated once you have notes this week and AI service is available.
                </p>
            </div>
        @endif
        ...
        @if(!empty($topics))
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                <h2 class="text-xl font-bold text-gray-900 mb-4">🏷️ Detected Topics</h2>
        ...
        @else
            <div class="bg-blue-50 border-l-4 border-blue-500 rounded-r-lg p-6">
                <p class="text-blue-800">
                    <strong>Tip:</strong> Topics will be automatically detected from your notes when AI service is available.
                </p>
            </div>
        @endif
    </div>
