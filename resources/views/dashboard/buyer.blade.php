    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 mb-6 text-center py-8">
                ...
                <p class="text-gray-600">No purchases yet. <a href="{{ route('marketplace.index') }}" class="text-blue-600 hover:text-blue-800 font-medium">Start exploring notes →</a></p>
            </div>
            @endif
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="border rounded-lg p-4 hover:shadow-md transition">
                        <h5 class="font-semibold text-gray-900 mb-2">{{ $collection->name ?? 'Collection' }}</h5>
