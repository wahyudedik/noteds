...
@section('title', 'Following Activity Feed')
...
<div class="py-8 sm:py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('activity.index') }}" class="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-md">
                        All Activities
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
            <form method="GET" action="{{ route('activity.following') }}" class="flex flex-wrap gap-4">
                ...
                <div class="flex items-end">
                    ...
                    @if(request()->has('type'))
                        <a href="{{ route('activity.following') }}" class="ml-2 px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold rounded-md">
                            Clear
                        </a>
                    @endif
                </div>
        ...
        <div id="activity-feed" class="space-y-4">
            ...
            @empty
                <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('marketplace.index') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md">
                            Discover Users
                        </a>
                    </div>
                </div>
        ...
        if (typeof Echo !== 'undefined') {
            ...
            Echo.channel('activity-feed')
                .listen('.activity.created', (e) => {
                    ...
                    const followingIds = @json(auth()->user()->following()->pluck('following_id')->toArray());
